	...
	public function city_datatable()
	{
		...
		foreach($city_manager as $city) 
		{
			...
			$subdata[] = date("d-m-Y H:i:s",strtotime($city['Createdon']));
			  ...
			  $set_rights .= '<div><a class="button tick" href="'.base_url().'dmcpan/city_manager/edit_details/'.$city['City_id'].'" data-toggle="tooltip" title="Edit"> <i class="fa fa-pencil" ></i> </a>';
			  } 
			  else 
			  { 
			  	$set_rights.="";
