	...
	public function forgot_password()
	{
		...
		if(count($forgot_pwd) > 0)
		{
			...
			$from_mail = 'info@vidyutinfo.com';
						...
						$mail_url = base_url().'dmcpan/clog/reset_password_page/'.urlencode(base64_encode($get_user_id));
						
						$reset_url = base_url().urlencode(base64_encode('dmcpan/clog/reset_password_page/')).urlencode(base64_encode($get_user_id));
