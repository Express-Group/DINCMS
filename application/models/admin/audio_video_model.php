	...
	if($check_in != '' && $check_out != '') {
			...
			if($CheckInYear <= $CurrentYear) {
					...
					if($Page_name == 'audio_manager') {
						...
						$SelectQuery = "content_id,title,publish_start_date,status, url,first_image_path,modified_by,modified_on,audio_image_path";
					} else {
						$TableName = "video_".$CheckInYear;
							$SelectQuery = "content_id,title,publish_start_date,status, url,first_image_path,modified_by,modified_on,video_image_path";
					}	
