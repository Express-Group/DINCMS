...
class Widget_model extends CI_Model
{
  ...
  public function __construct() 
	...
	public function get_liveContents_by_sectionId_count_rows($max_article, $section_id, $view_mode, $lead_story_maximum_Articles , $subsec_leadstory_remdering_mode, $leadstory_contentID, $contentType_id,$is_home)
	 {
	  $class_object = new Widget_config_class;
	  return $class_object->get_liveContents_by_sectionId_count_rows($max_article, $section_id, $view_mode, $lead_story_maximum_Articles , $subsec_leadstory_remdering_mode, $leadstory_contentID, $contentType_id,$is_home);
	 }
	 
	 public function get_liveContents_by_sectionId_count_array($max_article, $section_id, $view_mode, $lead_story_maximum_Articles , $subsec_leadstory_remdering_mode, $leadstory_contentID, $contentType_id,$is_home)
	 {
	  $class_object = new Widget_config_class;
	  return $class_object->get_liveContents_by_sectionId_count_array($max_article, $section_id, $view_mode, $lead_story_maximum_Articles , $subsec_leadstory_remdering_mode, $leadstory_contentID, $contentType_id,$is_home);
	 }
...
{ 
	...
	{ 
		$result  = $this->db->query('CALL other_stories_contents("'.$leadstory_contentID.'","'.$Section.'","'.$start_limt.'", "'.$length.'","'.$is_home.'", "'.$contentType_id.'", "'.$subsec_leadstory_remdering_mode.'")')->num_rows();	
	}
 ...
 public function get_liveContents_by_sectionId($max_article, $section_id, $view_mode, $lead_story_maximum_Articles , $subsec_leadstory_remdering_mode, $leadstory_contentID, $contentType_id,$is_home)
{
	...
	/*if($subsec_leadstory_remdering_mode == "manual" || $subsec_leadstory_remdering_mode == "auto" )
		$subsec_leadstory_remdering_mode = 1;
	else 
		$subsec_leadstory_remdering_mode = 2;*/
	if($view_mode == "live")
