...
class displaymodel extends askprabhu_model
{
	...
	public function update_user($Id,$userid)//to edit the desired records
	{
		...
		$this->db->query('CALL  update_askprabhu_qnlist ("'.$plain_textvalues.'","'.addslashes($html_values).'","'.$status.'","'.$Id.'","'.$modified_date.'","'.$userid.'")'); 
	}
   ...
   /* case 3:
	...
	//echo $this->db->last_query(); exit;	
		...
		//	$subdata[] = '<div align="left"><a class="Headtooltip" href="" data-toggle="tooltip" title="Edit">'.substr($section['Questiontext'], 0, 20).'...'.' <span>'.$section['Questiontext'].'</span> </a></div>';
			...
			if($section['Status']==1)
			$subdata[] = '<td><a data-toggle="tooltip" title="Approve" href="javascript:void()"><i class="fa fa-check"></i></a></td>';
			elseif($section['Status']==3)
			$subdata[] = '<td><a data-toggle="tooltip" title="Reject" href="javascript:void()"><i class="fa fa-times"></i></a></td>';
			else
			$subdata[] = '<td><a data-toggle="tooltip" title="Pending" href="javascript:void()"><i class="fa fa-exclamation-triangle"></i></a></td>';
			...
			/* $subdata[] ='<a class="button tick" href="'.base_url().'admin/askprabhu/call_edit_class/'.$section['Question_id'].'" data-toggle="tooltip" title="Edit"> <i class="fa fa-pencil" ></i> </a>
			  ...
			  $set_rights .= '<a class="button tick" href="'.base_url().'dmcpan/askprabhu/call_edit_class/'.$section['Question_id'].'" data-toggle="tooltip" title="Edit"> <i class="fa fa-pencil" ></i> </a>';
			  } 
			  else 
			  { 
			  	$set_rights.="";
