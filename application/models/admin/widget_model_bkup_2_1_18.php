...
class Widget_model extends CI_Model
{
 ...
 public function get_content_type($content_id)
	...
	public function GetLiveNewsCount($article_id){
		$class_object = new Widget_config_class;
		return $class_object->GetLiveNewsCount($article_id);
	}
...
class Widget_config_class extends Widget_model
{
	...
	public function GetLiveNewsCount($article_id){
		$this->load->database();
		return  $this->db->query("SELECT lid FROM livenowmaster WHERE status=0 AND article_id='".$article_id."'")->num_rows();
	}
