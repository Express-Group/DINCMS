            ...
            foreach($get_result as $key => $get_multi_section)
            {
               ...
               $sub_section_result = $list_multi_sectn->result_array();
				...
				foreach($sub_section_result as $sub_key => $sub_section) {
					...
					$sub_section_result[$sub_key]['BreadCrumb'] = $get_multi_section['Sectionname']."/".$sub_section['Sectionname'];
					...
					if($get_sub_sec_id != '' ) {
						...
						$sub_sub_result = $sub_list_multi_sectn->result_array();
						
						foreach($sub_sub_result as $sub_sub_key=>$sub_sub_result) {
						
						$sub_sub_result['BreadCrumb'] = $get_multi_section['Sectionname']."/".$sub_section['Sectionname']."/".$sub_sub_result['Sectionname'];
						
						$sub_section_result[$sub_key]['sub_sub_section'][$sub_sub_key] = $sub_sub_result;		
				...
				$get_result[$key]['BreadCrumb'] = $get_multi_section['Sectionname'];
