...
$widgettemplate = ($widgetId==405 ||$widgetId==406)?1 :0;
if($widgettemplate==0):
...
<div id="widgetConfigWindow">
  ...
  <div class="form-container">
    ...
    <form id="widget_config_form">
      ...
      <?php
      	if(strtolower($renderingType) != "3" && $widgetName!='external_api'  && $widgetName!='thalaipu_seithigal_new' && $widgetName!='top_seithigal_new' && $widgetName!='Homepage Latest News Block' && FPM_ADDADVSCRIPTS) { 
	  ?>
        ...
        <?php } ?>
		<?php if($widgetName=='external_api'): ?>
		...
		<?php endif; ?>
		<?php
			if($widgetName=='Mobile Script Widget(visible in mobile only)' || $widgetName=='Most Read Responsive'):
				?>
		...
		?>
		<?php if($widgetName=='thalaipu_seithigal_new' || $widgetName=='Homepage Latest News Block'): ?>
					 <li class="form-label" >Widget Style</li>
					  <li>
						<select name="widget_bg_color" id="widget_bg_color" >                        
							<option value="1">1 column</option>
							<option value="2">2 column</option>
							<?php if($widgetName!='Homepage Latest News Block'): ?>
							<option value="3">3 column</option>
							<option value="4">1 column (Hide date)</option>
							<option value="5">2 column (Hide date)</option>
							<option value="6">3 column (Hide date)</option>
							<?php endif; ?>
						</select>
					  </li>
		<?php endif; ?>
		<?php if($widgetName=='top_seithigal_new'): ?>
					 <li class="form-label" >Show Date</li>
					  <li>
						<select name="widget_bg_color" id="widget_bg_color" >                        
		...
		if(strtolower($widgetTitleEditatble) == "1") { ?>
        <li class="form-label">Widget Title</li>
        <li>
          <input type="text" name="widgetTitle" id="widgetTitle" maxlength="250" />
		...
		?>
		 <!-- start isSummary -->
        <?php if(strtolower($isSummaryAvailable) == "1"  && $widgetName!='Double Block Section Widget') { ?>
		...
		?>	
		<?php if($widgetName=='Double Block Section Widget') { ?>
                    <li class="form-label">Widget Style</li>
                    <li>                                          
                      <select name="showSummary" id="showSummary" >                        
        ...
        <?php 
                ...
                <li>                       
					<select name="renderingMode" id="renderingMode">
                        ...
                        <option value="ed" >edexlive</option>
                        <option value="in" >indulgexpress</option>
       ...
       <li>
        ...
        <li><div class="tab">
           <div class="switch switch-blue">
               <input type="radio" value="1" class="switch-input" checked="checked" name="status" id="status1"> 
               <label class="tab-12 switch-label switch-label-off" for="status1">Active</label>
               
               <input type="radio" value="2" class="switch-input" name="status" id="status2">
...
<div class="panel panel-primary" style="margin: 10px;">
    ...
    <div class="panel-body">
		<div class="form-group" style="width:100%;">
			<?php if($widgetId==406){ echo '<label>Module Type </label>'; }else{ echo '<label>Script title</label>'; } ?>
			<input type="text" value="<?php echo $tit ; ?>" id="widgettit" class="form-control style-form-control" >
		</div>
		<div class="form-group" style="width:100%;">
			<?php if($widgetId==406){ echo '<label>Module Value (ADMK,DMK,BJP,Independent)</label>'; }else{ echo '<label>Script Content</label>'; } ?>
