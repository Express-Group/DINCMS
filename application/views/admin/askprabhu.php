	...
	function delete_askprabhu(id)
		{
			...
			if(r==true){
			window.location.href="<?php echo base_url() ?>dmcpan/askprabhu/call_delete_class/"+id;
		}
	}
</script>
<script>
	...
	$('#example').dataTable( 
{
 ...
 $("#generate_qstnToWord").click(function()
 {
	...
	window.open("<?php echo base_url(); ?>dmcpan/askprabhu/question_document/"+checked_question1);
	}
	else
	{
...
$('#txtSearch').keypress(function (e) {
    ...
    .append($('<td class="BackArrow"><a href="<?php  echo base_url(); ?>dmcpan/askprabhu" data-toggle="tooltip" title="Back to list"><i class="fa fa-reply fa-2x"></i></a></td>'));
		   }
		   else
		   {
		...
		"ajax": {
            "url": "<?php echo base_url(); ?>dmcpan/askprabhu/askprabhu_datatable",
			"type" : "POST",
			"data" : {
