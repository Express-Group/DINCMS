	...
	<div class="BodyWhiteBG">
		<div class="BodyHeadBg Overflow clear">
			<div class="FloatLeft BreadCrumbsWrapper ">
				<div class="breadcrumbs">Dashboard >State</div>
 					<h2>State Manager</h2>
			</div>
           
             <p class="FloatRight SaveBackTop remoda1-bg"><a href="<?php echo base_url();?>dmcpan/state_manager/state_form_view" type="button" class="btn-primary btn"><i class="fa fa-plus-circle"></i>Add New</a></p>
...
<!--<i  id="state_search" class="fa fa-search FloatLeft" ></i>
<button class="btn-primary btn margin-left-50" type="button" id="clear_search">Clear Search</button>-->
 <button class="btn btn-primary" type="button" id="state_search">Search</button>
	...
	$('#example').dataTable( 
{
	...
	"aoColumnDefs": [
		...
		"ajax": {
            "url": "<?php echo base_url(); ?>dmcpan/state_manager/state_datatable",
			"type" : "POST",
			"data" : {
...
function delete_state(id)
		{
			...
			if(r==true){
			window.location.href="<?php echo base_url() ?>dmcpan/state_manager/state_delete/"+id;
		}
	}
