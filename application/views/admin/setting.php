...
<link rel="stylesheet" type="text/css" media="screen" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datetimepicker/3.1.1/css/bootstrap-datetimepicker.min.css">
<script type="text/javascript"  src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.29.1/moment.min.js"> </script>
<script type="text/javascript"  src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datetimepicker/3.1.1/js/bootstrap-datetimepicker.min.js"> </script>
...
<form id="setttings_form" name="setttings_form" method="post" action="<?php echo base_url(); ?>dmcpan/settings/insert_update" enctype="multipart/form-data">
	<div class="Container">
									...
									<div class="create-use-set">
										<div class="qnsans">
											...
											<div class="ans">
												...
												<input class="BorderBoxNone margin-top-5" id="speed" type="range" min="3" max="5" value="<?php if(isset($settings_result['breakingNews_scrollSpeed']) && $settings_result['breakingNews_scrollSpeed'] != "") { echo $settings_result['breakingNews_scrollSpeed']; } else { echo 2;} ?>" />
										...
										<div class="qnsans">
											...
											<div class="ans">
												...
												<div class="WidthPercentage margin-top-5 FloatLeft"> 
													<img src="<?php if(isset($settings_result['sitelogo']) && $settings_result['sitelogo'] != "") { echo static_url.$settings_result['sitelogo']; } else '#'; ?>" style="height:100px; width:450px;" id="logo_img" name="logo_img" border="0" />
										...
										<div class="qnsans">
											...
											<div class="ans">
												...
												<div class="margin-left-10 FloatLeft"> 
													<img src="<?php if(isset($settings_result['favouriteicon']) && $settings_result['favouriteicon'] != "") { echo static_url.$settings_result['favouriteicon']; } else '#'; ?>" style="height:35px; width:35px;" id="favicon_img" name="favicon_img" border="0" />
										...
										<div class="qnsans">
											<h3 class="br_top">Youtube Services</h3>
											<div class="qns">
												<div class="question">Playlist Id</div>
											</div>
											<div class="ans">
												<input type="text" class="tb_style2" maxlength="255" name="playlist_id" id="playlist_id" value="<?php if(isset($settings_result['youtube_playlistid']) && $settings_result['youtube_playlistid'] != "") { echo $settings_result['youtube_playlistid']; } ?>">
											</div>
										</div>
										<div class="qnsans">
											<div class="qns">
												<div class="question">Video Count</div>
											</div>
											<div class="ans">
												<input type="number" class="tb_style2" maxlength="255" name="youtube_count" id="youtube_count" value="<?php if(isset($settings_result['youtube_count']) && $settings_result['youtube_count'] != "") { echo $settings_result['youtube_count']; } ?>">
											</div>
										</div>
