...
$(document).ready(function()
{
	...
	{			
		...
		{ 
			required: true,
			remote : "<?php echo base_url();?>dmcpan/change_password/new_check_password"
		},
		txtNewPassword: 
		{ 
			required: true,
	...
	messages: 
	{
		...
		$("#btnSubmit").click(function() 
		{
			if($("#frmChangePassword").valid())
			{
					...
					url:"<?php echo base_url(); ?>dmcpan/change_password/check_password",
...
<form name="frmChangePassword" id="frmChangePassword" method="post" action="<?php echo base_url()."dmcpan/change_password/get_details";?>" enctype="multipart/form-data" >
