		...
		if($("#newsletter_table_form").valid())
		{
			...
			$("input[name='chk_value']").each(function()
			{
			 ...
			 if(r==true)
			 {
	 			$.ajax(
				{
					url:'<?php echo base_url()."dmcpan/newsletter_manager/newsletter_bulk_delete";?>',
					type:"POST",
					data:{ "emails" : required_values},
					success: function(data) 
					{
						newsletter_datatables();
						//location.href = "<?php echo base_url();?>dmcpan/newsletter_manager";
					}
				});
			 }
   ...
   $("#export_excel").click(function()
	{
		...
		$(this).attr("href", "<?php echo base_url();?>dmcpan/newsletter_manager/newsletter_export_excel/?ids="+selected_ids);
	});
});
function delete_newsletter(id)
		{
			...
			if(r==true){
			window.location.href="<?php echo base_url() ?>dmcpan/newsletter_manager/newsletter_delete/"+id;
		}
	}
</script>
...
function newsletter_datatables()
{
    ...
    .append($('<td class="BackArrow"><a href="<?php  echo base_url(); ?>dmcpan/newsletter_manager" data-toggle="tooltip" title="Back to list"><i class="fa fa-reply fa-2x"></i></a></td>'));
		   }
		   else
		   {
		...
		"ajax": 
		{
            "url": "<?php echo base_url(); ?>dmcpan/newsletter_manager/newsletter_datatable",
			"type" : "POST",
