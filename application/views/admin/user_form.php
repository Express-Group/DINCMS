							...
							<div class="user-top">
								<div class="qnsans">
									...
									<div class="ans-use">
										...
										<input type="text" name="txtUserName" autocomplete="off" id="txtUserName" maxlength="20" value="<?php if(isset($op_username)){ echo $op_username;}else{echo set_value('txtSectionName');}?>" class="user-style box-shad box-shad1">
