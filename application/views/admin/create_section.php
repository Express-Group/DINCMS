...
--><!--<script type="text/javascript" src="<?php echo image_url; ?>js/jquery-1.8.3.js"></script>-->
<!--pop-up-js-->
...
<script> 
	$(document).ready(function()
	{
		...
		{			
			...
			txtMetaDesc: { maxlength: 255 },
			txtMetaKeyword: { maxlength: 255 },
			fileBackgroundImage:
			{
				// required: true,	 
     			accept: "image/*"
			...
			if($("#frmSectionMaster").valid())
			{
				...
				success: function(result)
				{
					...
					else
					{
						...
						success: function(result)
						{
						if(result == "URL Section Name already exist" && $('#txtSectionId').val()=='')
					    {
    ...
    <div class="BodyWhiteBG">
      <div class="BodyHeadBg Overflow clear">
        ...
        <div class="FloatLeft BreadCrumbsWrapper">
          <div class="breadcrumbs">Dashboard > Edit Section</div>
          <h2 class="FloatLeft">Edit Section</h2>
        </div>
        <?php } else { ?>
        <div class="FloatLeft BreadCrumbsWrapper">
          <div class="breadcrumbs">Dashboard > Create Section</div>
          <h2 class="FloatLeft">Create Section</h2>
        </div>
        <?php } //echo $op_DisplayOrder; ?>
