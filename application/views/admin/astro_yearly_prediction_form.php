...
<div class="Container">
	<div class="BodyWhiteBG">
		...
		<?php } ?>		
		<form name="yearlyPredictions_form" id="yearlyPredictions_form" action="<?php echo base_url(); ?>dmcpan/astro_yearly_prediction/add_yearly_predictions" method="post" enctype="multipart/form-data">
			<div class="BodyHeadBg Overflow clear">
				...
				<a class="FloatLeft back-top" href="<?php echo base_url(); ?>dmcpan/astro_yearly_prediction"><i class="fa fa-reply fa-2x"></i></a>
...
<p id="already_error" style="color:#F00"></p>
									...
									<div class="panchangam-section1">
										<h4 class="ColorTheme">ஆண்டுப்பலன்<span id="mandatory">*</span></h4>
...
function call_infinite_scroll() {
 ...
 var $container = jqis('.popup_images');
	...
	$container.html('<div id="LoadingSelectImageLocal" style="display: block;"><img src="<?php echo base_url(); ?>images/admin/loadingimage.gif" style="border:none; width:23px; height:23px;text-align: center;float: none;margin: 0px;padding: 0px;"><br>Loading ...</div>');
			...
			$.ajax({
			url: base_url+"dmcpan/astro_image/get_image_library_scroll/1", // Url to which the request is send
...
jqis("#clear_search").show();
 ...
 var $container = jqis('.popup_images');
	...
	$container.html('<div id="LoadingSelectImageLocal" style="display: block;"><img src="<?php echo base_url(); ?>images/admin/loadingimage.gif" style="border:none; width:23px; height:23px;text-align: center;float: none;margin: 0px;padding: 0px;"><br>Loading ...</div>');
			...
			jqis.ajax({
				url: base_url+"dmcpan/astro_image/search_image_library",
				type: "POST",
				data: postdata,
				dataType: "json",
