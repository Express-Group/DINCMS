...
<div class="Container">
	<div class="BodyWhiteBG">
		...
		{ ?>
             <p class="FloatRight SaveBackTop remoda1-bg"><a href="<?php echo base_url();?>dmcpan/city_manager/city_form_view" type="button" class="btn-primary btn"><i class="fa fa-plus-circle"></i>Add New</a></p>
			  <?php }?>
	...
	$('#example').dataTable( 
{
	...
	"aoColumnDefs": [
		...
		"ajax": {
            "url": "<?php echo base_url(); ?>dmcpan/city_manager/city_datatable",
			"type" : "POST",
			"data" : {
...
function delete_city(id)
		{
			...
			if(r==true){
			window.location.href="<?php echo base_url() ?>dmcpan/city_manager/city_delete/"+id;
		}
	}
