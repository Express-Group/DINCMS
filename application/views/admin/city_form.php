		...
		$("#btnSave").click(function() 
		{
			if($("#frmcityMaster").valid())
			{
				...
				var cityid=$('#txthiddenid').val();
					...
					url:"<?php echo base_url(); ?>dmcpan/city_manager/check_cityname",
...
<form name="frmcityMaster" id="frmcityMaster" method="post" action="<?php echo base_url()."dmcpan/city_manager/city_details";?>" enctype="multipart/form-data" >
...
<p class="FloatRight save-back save_margin">
 <a class="FloatLeft back-top" href="<?php echo base_url()."dmcpan/city_manager";?>"><i class="fa fa-reply fa-2x"></i></a>
