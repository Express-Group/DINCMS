...
<div class="Container">
	<div class="BodyWhiteBG">
		<div class="BodyHeadBg Overflow clear">
          ...
          <?php $data['Menu_id'] = get_menu_details_by_menu_name('Column');
		if(defined("USERACCESS_ADD".$data['Menu_id']) && constant("USERACCESS_ADD".$data['Menu_id']) == 1) 
		{ ?>
             <p class="FloatRight SaveBackTop remoda1-bg"><a href="<?php echo base_url();?>dmcpan/topic_manager/topic_form_view" type="button" class="btn-primary btn"><i class="fa fa-plus-circle"></i>Add New</a></p>
			 <?php }?>
...
<label for="search_based_check">Search Based on Date Range</label></div><a href="#" class=""></a>
       ...
       <li>
<p class="CalendarWrapper" id="checkin_checkout_div"> <label for="search_based_check">Search Based on Date Range</label><input type="text" value="" id="date_timepicker_start" readonly placeholder="Start Date"><input type="text" value="" id="date_timepicker_end" placeholder="End Date" readonly></p>
 </li>
	...
	function delete_topic(id)
		{
			...
			if(r==true){
			window.location.href="<?php echo base_url() ?>dmcpan/topic_manager/topic_delete/"+id;
		}
	}
</script>
<script>
	...
	$('#example').dataTable( 
{
	...
	"aoColumnDefs": [
		...
		"ajax": {
            "url": "<?php echo base_url(); ?>dmcpan/topic_manager/topic_datatable",
			"type" : "POST",
			"data" : {
