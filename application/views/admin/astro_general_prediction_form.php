...
<div class="Container">
	<div class="BodyWhiteBG">
		...
		<?php } ?>
		<form name="generalPredictions_form" id="generalPredictions_form" action="<?php echo base_url(); ?>dmcpan/astro_general_prediction/add_general_predictions" method="post" enctype="multipart/form-data">
			<div class="BodyHeadBg Overflow clear">
				...
				<a class="FloatLeft back-top" href="<?php echo base_url(); ?>dmcpan/astro_general_prediction"><i class="fa fa-reply fa-2x"></i></a>
...
<p id="already_error" style="color:#F00"></p>
									...
									<div class="panchangam-section1">
										<h4 class="ColorTheme">பொதுப்பலன்<span id="mandatory">*</span></h4>
