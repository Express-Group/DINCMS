...
<script type="text/javascript" src="<?php echo base_url();?>js/numerology_weekly_predictions.js"></script>
...
{
	$title1 = 'Numerology Weekly predictions - Edit';
}else{ $title1 = 'Numerology Weekly predictions - Create';}
...
<div class="Container">
	<div class="BodyWhiteBG">
		...
		<?php } ?>
		<form name="weeklyPredictions_form" id="weeklyPredictions_form" action="<?php echo base_url(); ?>dmcpan/numerology_weekly_prediction/add_weekly_predictions" method="post" enctype="multipart/form-data">
			<div class="BodyHeadBg Overflow clear">
				...
				<a class="FloatLeft back-top" href="<?php echo base_url(); ?>dmcpan/numerology_weekly_prediction"><i class="fa fa-reply fa-2x"></i></a>
							    ...
							    <div class="panchangam-date1">
									...
									<div class="ans panchangam-date">
										<div id="datetimepicker1" class="input-append date panchangam-kalam">
											...
											<span style="padding-left:20px;"><input type="text" name="prediction_end_date" id="prediction_end_date" value="<?php if(isset($fetch_values['prediction_end_date']) && $fetch_values['prediction_end_date'] != "") { echo $fetch_values['prediction_end_date'];} ?>"  readonly />	</span>
...
<p id="already_error" style="color:#F00"></p>
									...
									<div class="panchangam-section1">
										<h4 class="ColorTheme">வாரப்பலன்<span id="mandatory">*</span></h4>
	...
	<script type="text/javascript" src="<?php echo base_url(); ?>js/jquery.remodal.js"></script>
	 <script language="javascript">
		...
		$("#preview_id").click(function() {
			...
			var postdata = {"body_text" :body_text,"date": date,"number":number,"menu_name":'<?php echo 'Numerology Weekly Prediction'; ?>'};
			$.ajax({
		...
		function updateAb(selected)
		{
			...
			if(date !='')
			{
				$.ajax({
					...
					url: base_url+"dmcpan/numerology_weekly_prediction/change_dateFormat",
