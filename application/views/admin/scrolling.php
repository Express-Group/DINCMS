...
<div class="Container">
	<div class="BodyHeadBg Overflow clear">
		...
		<table class="table table-bordered" id="table-jquery">
			...
			print '<td>'.$i.'</td>';
			print '<td class="content_'.$data->sid.'">'.$data->title.'</td>';
			print '<td><img src="'.image_url.'uploads/scroll_news/'.$data->image.'" style="width:100px;"></td>';
			...
			<div class="modal-dialog">
			  <div class="modal-content">
				...
				<div class="modal-body">
					<form method="post" action="<?php echo base_url(folder_name.'/scrolling_news/save_news') ?>" id="form-s" enctype="multipart/form-data">
					<div class="form-group">
						<label>Enter Title:</label>
						<input type="text" id="headline" name="headline" value="" class="form-control">
					</div>
					<div class="form-group">
						<label>Image: (upload Jpg File)</label>
	  ...
	  <div class="modal fade" id="edit_news" role="dialog">
			<div class="modal-dialog">
			  <div class="modal-content">
				...
				<div class="modal-body">
					<form method="post" action="<?php echo base_url(folder_name.'/scrolling_news/save_edit_news') ?>" id="form-e" enctype="multipart/form-data">
					<div class="form-group">
						<label>Enter Title:</label>
						<input type="text" id="headline1" name="headline1" value="" class="form-control">
					</div>
					<div class="form-group">
						<label>Image: (upload Jpg File)</label>
						<input type="file" name="simage1" id="simage1"  class="form-control">
	...
	$.ajax({
		...
		success: function(result){
			if(result.response==1){
				...
				$('#headline1').val(result.headline);
				$('#edit_new_id').val(sid);
				$("#edit_news").find('img').attr('src','<?php echo image_url ?>uploads/scroll_news/'+result.image);
