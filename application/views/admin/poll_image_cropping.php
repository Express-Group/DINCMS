...
<link href="<?php echo $script_url;  ?>css/admin/tag/bootstrap.css" rel="stylesheet" type="text/css" />
<link href="<?php echo $script_url;  ?>css/admin/cropper.css"  rel="stylesheet" type="text/css" >
<link href="<?php echo $script_url;  ?>css/admin/main.css"  rel="stylesheet" type="text/css" >
<link href="<?php echo $script_url;  ?>css/admin/elastislide.css"  rel="stylesheet" type="text/css">
<link rel="stylesheet"  href="<?php echo $script_url; ?>css/admin/jquery-ui-autocomplete.css" type="text/css" />
<link rel="stylesheet" href="<?php echo $script_url; ?>css/admin/jquery-ui-custom.css">
...
<div class="Container" style="width:1170px;">
	<div class="BodyWhiteBG">
		<div class="BodyHeadBg Overflow clear">
			<div class="breadcrumbs"><a href="javascript:void(0);">Dashboard</a> > <a href="javascript:void(0);">
				<?php  echo "Resize & Crop Image"; ?>
				</a></div>
			...
			<p class="FloatRight save-back save_margin article_save">
				...
				<button type="button" class="btn btn-primary FloatRight i_button"  id="active_id" title="Save" ><i class="fa fa-floppy-o"></i></i> </button>
			</p>
		</div>
		<div class="Overflow DropDownWrapper">
			<div class="form_list_new">
				...
				<div class="CroppingSize">
					<input type="checkbox" name="image_resize" id="image_resize_id" class="WidthAuto margin-right-10" value="image_600_390" <?php if($last_crop_image['imgtype600X390'] != 2) {  } ?> />
					<label>600px X 390px</label>
					<?php if($this->uri->segment(2) != 'gallery_image_processing') { ?>
					<input type="checkbox" name="image_resize" id="image_resize_id" class="WidthAuto" value="image_600_300" <?php if($last_crop_image['imgtype600X300'] != 2) {  } ?>  />
					<label>600px X 300px</label>
					<input type="checkbox" name="image_resize" id="image_resize_id" class="WidthAuto" value="image_150_150"  <?php if($last_crop_image['imgtype100X65'] != 2) { echo "checked"; } ?>  />
					<label>150px X 150px</label>
					<?php } ?>
					<input type="checkbox" name="image_resize" id="image_resize_id" class="WidthAuto" value="image_100_65" <?php if($last_crop_image['imgtype150X150'] != 2) {  } ?>  />
					<label>100px X 65px</label>
				</div>
				...
				<section class="GalleryTabsContent">
					<div class="tabcontents margin-top-10">
						<div id="view1" style="display: block;">
							<div class="AutoCropper"> <img id="resize_image_content" style="width:600px;height:390px;" <?php if(!isset($last_crop_image['imgsrc']) || $last_crop_image['imgsrc'] == '' || $last_crop_image['imgsrc'] == 'NULL') { ?> style="display:none;" <?php } ?> src="<?php if(isset($last_crop_image['imgsrc'])) { echo $last_crop_image['imgsrc']; } ?>"  /> </div>
						</div>
						<?php if($this->uri->segment(2) != 'gallery_image_processing') { ?>
						<div id="view2" style="display:none;">
							<div class="AutoCropper"> <img id="resize_image_content"  style="width:600px;height:300px;" <?php if(!isset($last_crop_image['imgsrc']) || $last_crop_image['imgsrc'] == '' || $last_crop_image['imgsrc'] == 'NULL') { ?> style="display:none;" <?php } ?> src="<?php if(isset($last_crop_image['imgsrc'])) { echo $last_crop_image['imgsrc']; } ?>"  /> </div>
						</div>
						<div id="view3" style="display:none;">
							<div class="AutoCropper"> <img id="resize_image_content"  style="width:150px;height:150px;" <?php if(!isset($last_crop_image['imgsrc']) || $last_crop_image['imgsrc'] == '' || $last_crop_image['imgsrc'] == 'NULL') { ?> style="display:none;" <?php } ?> src="<?php if(isset($last_crop_image['imgsrc'])) { echo $last_crop_image['imgsrc']; } ?>" /> </div>
						</div>
						<?php } ?>
						<div id="view4" style="display:none;">
							<div class="AutoCropper"> <img id="resize_image_content"  style="width:100px;height:60px;" <?php if(!isset($last_crop_image['imgsrc']) || $last_crop_image['imgsrc'] == '' || $last_crop_image['imgsrc'] == 'NULL') { ?> style="display:none;" <?php } ?> src="<?php if(isset($last_crop_image['imgsrc'])) { echo $last_crop_image['imgsrc']; } ?>" /> </div>
						</div>
					</div>
				</section>
				<section class="GalleryTabsContent BorderBoxNone margin-top-0">
					<div class="tabcontents img_tab_contents">
						<div class="img_gallery">
							<div align="center" style="display:none;" id="loadingcrop"><img src="<?php echo base_url();?>images/loadingimage.gif" style="border:none; width:30px; height:30px;" /><br />
								Please wait while we cropping the image....... </div>
							...
							<div align="center" style="display:none;" id="loadingdragimage"><img src="<?php echo base_url();?>images/loadingimage.gif" style="border:none; width:30px; height:30px;" /><br />
								Please wait while we add the images....... </div>
						</div>
						<div class="CropperWrapper" id="crop_container" <?php if(isset($last_crop_image['imgsrc']) && $last_crop_image['imgsrc'] != '') {} else{ ?> style="display:none;" <?php } ?>>
							...
							<div class="CroppingSize">
								<input type="radio" name="image_type" id="image_type_id" class="WidthAuto margin-right-10" value="image_600_390" checked />
								<label>600px X 390px</label>
								<?php if($this->uri->segment(2) != 'gallery_image_processing') { ?>
								<input type="radio" name="image_type" id="image_type_id" class="WidthAuto" value="image_600_300" />
								<label>600px X 300px</label>
								<input type="radio" name="image_type" id="image_type_id" class="WidthAuto" value="image_150_150" />
								<label>150px X 150px</label>
								<?php } ?>
								<input type="radio" name="image_type" id="image_type_id" class="WidthAuto" value="image_100_65" />
								<label>100px X 65px</label>
							</div>
									...
									<div class="edit_image">
										<div class="edit_tools">
											<div id="rightsidescrollimagecontainer">
												<div id="loadingrightimage" align="center" style="display:none;"> <img src="<?php echo base_url();?>images/loadingroundimage.gif" border="0" style="width:18px; height:18px;" /><br />
													loading</div>
				 ...
				 -->
										...
										<div class="img-container"> <img id="crop_image_src" src="<?php echo $last_crop_image['imgsrc'];?>"  class="rotatecontrol"  border="0"   /> </div>
									</div>
								</div>
							</div>
							<div class="PreviewCroppped">
								...
								<figure class="GalleryImageSize1">
									...
									<img id="image_600_390" class="MainImage1" <?php if(!isset($last_crop_image['image_binary_file600X390']) || $last_crop_image['image_binary_file600X390'] == '' || $last_crop_image['image_binary_file600X390'] == 'NULL') { ?> style="display:none;" <?php } ?> src="<?php if(isset($last_crop_image['image_binary_file600X390'])) { echo $last_crop_image['image_binary_file600X390']; } ?>" > </figure>
								<?php if($this->uri->segment(2) != 'gallery_image_processing') { ?>
								<figure  class="GalleryImageSize1">
									<p>Size : 600px X 300px</p>
									<img id="image_600_300" class="MainImage2" <?php if(!isset($last_crop_image['image_binary_file600X300']) || $last_crop_image['image_binary_file600X300'] == '' || $last_crop_image['image_binary_file600X300'] == 'NULL') { ?> style="display:none;" <?php } ?> src="<?php if(isset($last_crop_image['image_binary_file600X300'])) { echo $last_crop_image['image_binary_file600X300']; } ?>" > </figure>
								<figure  class="GalleryImageSize1">
									<p>Size : 150px X 150px</p>
									<img id="image_150_150" class="SquareImage" <?php if(!isset($last_crop_image['image_binary_file150X150']) || $last_crop_image['image_binary_file150X150'] == '' || $last_crop_image['image_binary_file150X150'] == 'NULL') { ?> style="display:none;" <?php } ?> src="<?php if(isset($last_crop_image['image_binary_file150X150'])) { echo $last_crop_image['image_binary_file150X150']; } ?>" > </figure>
								<?php } ?>
								<figure class="GalleryImageSize1">
									<p>Size : 100px X 65px</p>
									<img id="image_100_65" class="ThumbImage" <?php if(!isset($last_crop_image['image_binary_file100X65']) || $last_crop_image['image_binary_file100X65'] == '' || $last_crop_image['image_binary_file100X65'] == 'NULL') { ?> style="display:none;" <?php } ?> src="<?php if(isset($last_crop_image['image_binary_file100X65'])) { echo $last_crop_image['image_binary_file100X65']; } ?>" > </figure>
							</div>
...
<script src="<?php echo $script_url ; ?>js/cropper.js"  type="text/javascript" ></script> 
<script src="<?php echo $script_url ; ?>js/main.js"  type="text/javascript"></script> 
<script src="<?php echo $script_url ; ?>js/bootstrap/bootstrap.min.js"  type="text/javascript"></script> 
<script src="<?php echo $script_url ; ?>js/poll_image_crop.js" type="text/javascript"></script> 
<script type="text/javascript">
...
$(document).ready(function () {
	...
	options = {};
	//crop_box_size = {'left': 50,'top':50,'height':520,'width':800};
