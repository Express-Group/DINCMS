...
<div class="ArticleImageContainer1" id="audio_video_image_container" style="float:none; width:200px;<?php if(!isset($get_audio_video_details['image_details']['image_id'])) { echo "display:none;"; } else { echo "display:block;"; } ?>">
			...
			<label>Caption :</label>
			<input type="text" id="audio_video_image_caption" name="audio_video_image_caption" maxlength=200 value="<?php echo htmlentities(@$get_audio_video_details['image_details']['caption']);   ?>" class="margin-top-5 WidthFull valid" aria-invalid="false">
			<label>Image Alt :</label>
			<input type="text" id="audio_video_image_alt" name="audio_video_image_alt" maxlength=200 value="<?php echo htmlentities(@$get_audio_video_details['image_details']['alt_tag']);   ?>" class="margin-top-5 WidthFull valid" aria-invalid="false">
