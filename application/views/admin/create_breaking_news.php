...
<div class="Container">
    <div class="BodyWhiteBG">
    	<form action="<?php echo base_url(); ?>dmcpan/breaking_news_manager/brkingNews_func" id="brkng_news_form" name="brkng_news_form" method="post" enctype="multipart/form-data">
            <div class="BodyHeadBg Overflow clear">
                <div class="breadcrumbs">Dashboard > <?php echo $set_page_name; ?></div>
                 ...
                 <a class="FloatLeft back-top" href="<?php echo base_url();?>dmcpan/breaking_news_manager/"><i class="fa fa-reply fa-2x"></i></a>
