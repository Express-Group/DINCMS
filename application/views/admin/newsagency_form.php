		...
		$("#btnSave").click(function() 
		{
			if($("#frmnewsagencyMaster").valid())
			{
				...
				var agencyid=$('#txthiddenid').val();
					...
					url:"<?php echo base_url(); ?>dmcpan/newsagency_manager/check_agencyname",
...
<form name="frmnewsagencyMaster" id="frmnewsagencyMaster" method="post" action="<?php echo base_url()."dmcpan/newsagency_manager/newsagency_details";?>" enctype="multipart/form-data" >
...
<p class="FloatRight save-back save_margin">
 <a class="FloatLeft back-top" href="<?php echo base_url()."dmcpan/newsagency_manager";?>"><i class="fa fa-reply fa-2x"></i></a>
