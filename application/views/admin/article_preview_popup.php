  ...
  <div class="row"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><div class="bcrums"> 
	...
	<?php } }
	 ...
	 <?php if($content_type == 1) { ?>
      ...
      <p class="ArticlePublish margin-bottom-10"><?php if($author_name != '') { ?>By <span><?php echo $author_name; ?></span>&nbsp;&nbsp;|&nbsp;&nbsp;<?php }  if($last_update != '') { ?>Published on:<span> <?php echo $last_update; ?></span>&nbsp;&nbsp;|&nbsp;&nbsp;<?php } ?><span class="FontSize" id="incfont">A+</span> <span class="FontSize" id="resetMe">A&nbsp;</span><span class="FontSize" id="decfont">A-</span>&nbsp;&nbsp;|&nbsp;&nbsp;<i class="fa fa-print fa_social"></i></p>
	 <?php } else { ?>
	 
      <p class="ArticlePublish"><?php if($author_name != '') { ?>By <span><?php echo ucfirst($author_name); ?></span>&nbsp;&nbsp;|&nbsp;&nbsp;<?php } ?></span><?php if($last_update != '') { ?>Published on:<span> <?php echo $last_update; ?></span>&nbsp;&nbsp;&nbsp;&nbsp;<?php } ?></p>
