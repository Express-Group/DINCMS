...
<div class="CompareArticle">
 ...
 ?>
        ...
        <li><input type="checkbox" name="chkAddArticle" class="select_check" value=1 <?php if(isset($article_opt)){ if( $article_opt == 1){?>checked='checked'<?php }}else{echo set_checkbox('chkAddArticle',1);}?> ><label>Add article</label></li>
        <li><input type="checkbox" name="chkAdvertisement" class="select_check" value=1 <?php if(isset($Ad_option)){ if( $Ad_option == 1){?>checked='checked'<?php }}else{echo set_checkbox('chkAdvertisement',1);}?>><label>Add Advertisement Script</label></li>
