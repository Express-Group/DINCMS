...
$data['Menu_id'] = get_menu_details_by_menu_name('Columnist');
		...
		{ ?>
 <p class="FloatRight SaveBackTop"><a href="<?php echo base_url();?>dmcpan/author_manager/<?php echo $page_name; ?>" type="button" class="btn-primary btn"><i class="fa fa-plus-circle"></i>Add New</a></p>
 <?php }?>
</div></a>
...
function author_datatables()
 {
    ...
    $('#example').dataTable( {
	   ...
	   oLanguage: {
		...
		"ajax": {
            "url": "<?php echo base_url(); ?>dmcpan/author_manager/author_datatable",
			"type" : "POST",
			"data" : {
...
function delete_author(id,name)
		{
			...
			if(r==true)
			{
				window.location.href="<?php echo base_url() ?>dmcpan/author_manager/delete_author/"+id+"/<?php echo $type; ?>";
			}
		}
