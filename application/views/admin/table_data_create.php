...
<div class="Container">
  <div class="BodyWhiteBG">
    <form name="frmtableMaster" id="frmtableMaster" method="post" action="<?php echo base_url()."dmcpan/table_result_manager/table_details";?>" enctype="multipart/form-data" >
...
{?>
        ...
        <p class="FloatRight save-back save_margin"> <a class="FloatLeft back-top" href="<?php echo base_url()."dmcpan/table_result_manager";?>"><i class="fa fa-reply fa-2x"></i></a>
		...
		$("#btnSave").click(function() 
		{
			if($("#frmtableMaster").valid())
			{
				...
				var tid = $('#t_id').val();
					...
					url:"<?php echo base_url(); ?>dmcpan/table_result_manager/check_tabletypename",
					success: function(result)
					{
						...
						else
						{
							...
							if(r==true)
							{
								...
								$.ajax({
										type: "post",
										url: "<?php echo base_url()?>dmcpan/table_result_manager/table_details",
										...
										success: function(data){
											window.location.href="<?php echo base_url() ?>dmcpan/table_result_manager/?status="+data;
										 },
							           });
							}
							else
