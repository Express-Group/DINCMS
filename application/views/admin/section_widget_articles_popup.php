...
$redirect_url_array = array(
	"dmcpan/edit_article/" => 1,
	"dmcpan/edit_gallery/" => 3,
	"dmcpan/audio_video_manager/edit_data/4/" => 4,
	"dmcpan/audio_video_manager/edit_data/5/" => 5
);
switch($contenttype_id)
{
	case 1:
		$article_type_redirect_url = "dmcpan/edit_article/";
		break;
	
	case 3:
		$article_type_redirect_url = "dmcpan/edit_gallery/";
		break;
	
	case 4:
		$article_type_redirect_url = "dmcpan/edit_video/";
		break;
	
	case 5:
		$article_type_redirect_url = "dmcpan/edit_audio/";
		break;
...
if(count($instance_added_article) > 0)
{
	...
	{
		if($parent_section_id == $instance_article_value['section_id'] or ($widget_type != 1 || $widget_type != 5))
		{
