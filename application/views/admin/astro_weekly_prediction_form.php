...
<div class="Container">
	<div class="BodyWhiteBG">
		...
		<?php } ?>
		<form name="weeklyPredictions_form" id="weeklyPredictions_form" action="<?php echo base_url(); ?>dmcpan/astro_weekly_prediction/add_weekly_predictions" method="post" enctype="multipart/form-data">
			<div class="BodyHeadBg Overflow clear">
				<div class="FloatLeft BreadCrumbsWrapper">
					<div class="breadcrumbs"><a href="<?php echo base_url(); ?>dmcpan">Dashboard ></a><a href="#">Astrology -</a>  <a href="#"><?php echo $title; ?></a></div>
				...
				<p class="FloatRight save-back save_margin article_save"> 
				 <a class="FloatLeft back-top" href="<?php echo base_url(); ?>dmcpan/astro_weekly_prediction"><i class="fa fa-reply fa-2x"></i></a>
...
<div class="qns"><label class="question">Raasi Name<span style="color:#F00">*</span></label></div>
	...
	<link rel="stylesheet" type="text/css" href="http://cdn.jsdelivr.net/bootstrap/latest/css/bootstrap.css" />	
	 ...
	 <script language="javascript">
		...
		$("#preview_id").click(function() {
			...
			url: "<?php echo base_url(); ?>dmcpan/article_manager/get_astrology_preview_popup",  // Url to which the request is send
		...
		function updateAb(selected)
		{
			...
			if(date !='')
			{
				$.ajax({
					...
					url: base_url+"dmcpan/astro_weekly_prediction/change_dateFormat",
