	...
	messages: 
	{
		...
		$("#btnSubmit").click(function() 
		{
			if($("#frmChangePassword").valid())
			{
					...
					url:"<?php echo base_url(); ?>dmcpan/clog/reset_password/<?php echo $userID; ?>",
...
<div class="Container">
	<div class="BodyWhiteBG BorderBoxNone">
		<div class="poll_content" style="padding-right:10px;">
			<div class="login">
				<!--<form name="frmChangePassword" id="frmChangePassword" method="post" action="<?php //echo base_url(); ?>dmcpan/clog/reset_password/<?php //echo $userID; ?>" enctype="multipart/form-data" >-->
...
Password has been reset succesfully. You can <a href="<?php echo base_url(); ?>dmcpan/clog/" style="text-decoration: underline;">Click here</a> to login
</div>