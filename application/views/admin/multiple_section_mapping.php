 <ul class="tree_head_ul">
				...
				switch($content_type) {
				 ...
				 if($condition && $mapping['Section_id']!=781) {
			     ...
			     <li><input  class="myClass" type="checkbox"   id="section_mapping<?php echo $sub_mapping['Section_id']; ?>"  name="cbSectionMapping[]" main_section="<?php echo $mapping['Sectionname']; ?>"  sub_main_section="" rel="<?php echo $sub_mapping['Sectionname']; ?>" value="<?php echo $sub_mapping['Section_id']; ?>" <?php if(isset($mapping_section) && in_array($sub_mapping['Section_id'],$mapping_section)) echo  "checked"; if(isset($get_article_details['content_id']) && $get_article_details['Section_id'] == $sub_mapping['Section_id'] ) {  ?> style="visibility:hidden;" <?php } ?> <?php if($sub_mapping['Section_landing'] == 1) { echo "disabled"; } ?> />	<label for="section_mapping<?php echo $sub_mapping['Section_id']; ?>"><?php echo $sub_mapping['Sectionname']; ?></label>
					...
					<?php   } ?>
					<?php if($mapping['Sectionname']=='முகப்பு'){
						if(isset($mapping_section) && in_array(781,$mapping_section)){
							echo '<li><input class="myClass" checked type="checkbox" id="section_mapping781" name="cbSectionMapping[]" main_section="" sub_main_section="" rel="Glance" value="781"> <label class="tree_list_color" for="section_mapping781"><i class="fa fa-caret-right" val="1" id="MainSectionMapping"></i> Glance</label></li>';
						}else{
							echo '<li><input class="myClass" type="checkbox" id="section_mapping781" name="cbSectionMapping[]" main_section="" sub_main_section="" rel="Glance" value="781"> <label class="tree_list_color" for="section_mapping781"><i class="fa fa-caret-right" val="1" id="MainSectionMapping"></i> Glance</label></li>';
						}
