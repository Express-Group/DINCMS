...
.article_summary{padding-bottom: 43px;}
</style>
...
.pagination-custom{width: 4%;left: 95% !important;top: 73px !important;height: 28px;}
.pagination-custom span{padding:2px;}
 pager{ width:99%;float:left;background:#3c8dbc;color:#fff;text-align:center;padding:5px;}
...
<button class="btn btn-primary FloatRight" style="padding: 9px 7px 8.3px !important;"  id="publishtop_close" title="Publish &close" >Publish & Close</button>
...
<button  style="padding: 11.4px !important;" class="btn btn-primary FloatRight" id="clear_cache" onclick="removelocalstoreddata();javascript:location.reload();"  title="clear cache"><span><i class="fa fa-eraser" aria-hidden="true"></i></span></button>
...
<p class="title-temp" style="font-weight: bold;color: #df0d0d;text-align: center;"><?php echo set_value('txtArticleHeadLine'); ?><?php  if(isset($get_article_details['title'])) echo strip_tags($get_article_details['title']); ?></p>
<?php 
...
<!--<textarea class="ckeditor"  id="article_head_line_id" name="txtArticleHeadLine"><?php echo set_value('txtArticleHeadLine'); ?><?php  if(isset($get_article_details['title'])) echo strip_tags($get_article_details['title']); ?></textarea>-->
<input style="width:100%;" type="text" id="article_head_line_id1" name="txtArticleHeadLine" value="<?php echo set_value('txtArticleHeadLine'); ?><?php  if(isset($get_article_details['title'])) echo strip_tags($get_article_details['title']); ?>">
            ...
            <input type="text" class="box-shad1 full-width" id="txtUrlTitle" name="txtUrlTitle"  <?php if(isset($get_article_details['url_title'])) { echo "readonly"; } ?>  value="<?php if(isset($get_article_details['url_title'])) echo htmlentities($get_article_details['url_title']); echo set_value('txtUrlTitle'); ?>" />
			 ...
			 <?php } ?>
			<div class="article_meta" style="width: 92%;">
	<label>Meta Title<sup>*</sup></label>
    <div class="FloatLeft" style="width: 100%;">
        <input style="width: 100%;" id="count1" maxlength="100" name="txtMetaTitle" type="text" value="<?php if(isset($get_article_details['MetaTitle'])) echo htmlentities($get_article_details['MetaTitle']); echo htmlentities(set_value('txtMetaTitle')); ?>" class="box-shad1"/>
        <?php echo form_error('txtMetaTitle'); ?>
    </div>
    <div style="margin-top: 0;" id="charNum1" class="charNum"><?php if(isset($get_article_details['MetaTitle'])) echo 100 - mb_strlen($get_article_details['MetaTitle']); else echo "100"?></div>
</div>	
...
<textarea class="ckeditor" id="summary"  name="txtSummary"><?php if(isset($get_article_details['summaryHTML'])) echo $get_article_details['summaryHTML']; echo set_value('txtSummary'); ?></textarea>
 <?php echo form_error('txtSummary'); ?>
		   ...
		   <label class="WidthAuto">Body Text<sup>*</sup></label>
			  ...
			  <a class="pagination-custom btn-primary btn FloatRight EmbedImage" 
			  onclick="add_pager();" title="pagination"><span><i class="fa fa-arrows " aria-hidden="true"></i></span></a>
		</div>
...
<textarea class="ckeditor" id="body_text" name="txtBodyText"><?php if(isset($get_article_details['ArticlePageContentHTML'])) echo $get_article_details['ArticlePageContentHTML']; echo set_value('txtBodyText'); ?></textarea>
 ...
 <button type="button" class="btn btn-primary translate-content" style="float: left;margin: 7px 0 0 !important; padding: 3px 6px 2px !important;"><i class="fa fa-globe" aria-hidden="true"></i> translate</button>
 <span id="article_body_error"></span>
            </div>
            <div class="article_image">
            <p>Images
			<label style="float: right;width: auto;margin: 0;margin-left: 7px;">Add Watermark</label>
			<input type="checkbox" name="watermark" style="float: right;margin:0 !important;height: 20px;width: 15px;">
			</p>
          ...
          <p>Preview</p>
			...
			<label>Caption :</label>
			<input type="text" id="home_image_caption"   name="home_image_caption" maxlength=200 value="<?php echo htmlentities(@$get_article_details['homepageimageid']['temp_caption']);   ?>" class="margin-top-5 WidthFull" />
			<label>Image Alt :</label>
			<input type="text" id="home_image_alt"  name="home_image_alt" maxlength=200 value="<?php echo htmlentities(@$get_article_details['homepageimageid']['temp_alt']);   ?>" class="margin-top-5 WidthFull">
        ...
        <p style="">Preview</p>
		   ...
		   <label>Caption :</label>
		   <input type="text" value="<?php echo htmlentities(@$get_article_details['Sectionimageid']['temp_caption']);   ?>" name="section_image_caption"  id="section_image_caption" maxlength=250  class="margin-top-5 WidthFull" />
		   <label>Image Alt :</label>
		   <input type="text" value="<?php echo htmlentities(@$get_article_details['Sectionimageid']['temp_alt']);   ?>" name="section_image_alt"    class="margin-top-5 WidthFull"  id="section_image_alt" maxlength=250   />
		   <label>Image Name :</label>
        ...
        <p style="">Preview</p>
		  ...
		  <label>Caption :</label>
		   <input type="text" value="<?php echo htmlentities(@$get_article_details['articleimageid']['temp_caption']);   ?>" name="article_image_caption"  maxlength=200  class="margin-top-5 WidthFull" id="article_image_caption" />
		   <label>Image Alt :</label>
		   <input type="text" value="<?php echo htmlentities(@$get_article_details['articleimageid']['temp_alt']);   ?>" name="article_image_alt"   class="margin-top-5 WidthFull" maxlength=200 id="article_image_alt" />
		   <label>Image Name :</label>
    ...
    <?php echo form_error('ddCity'); ?>
           ...
           <input type="checkbox"  name="cbAllowComments" id="cbAllowComments"  <?php if(set_value("cbAllowComments") == 'on' || $page_name != 'edit_article' ||  (isset($get_article_details['Allowcomments']) && $get_article_details['Allowcomments'] == 1 ) ) echo  "checked"; ?> />
            <label for="cbAllowComments" class="margin-bottom-0">Allow Comments</label>
			  ...
			  <div class="padding-bottom-5">
         <!--  <input type="checkbox"  name="cbAllowPagination" id="cbAllowPagination"  <?php //if((isset($get_article_details['allow_pagination']) && $get_article_details['allow_pagination'] == 1 ) ) echo  "checked"; ?> />-->
		   <!-- <input type="checkbox"  name="cbAllowPagination" id="cbAllowPagination"  <?php //if(set_value("cbAllowPagination") == 'on' || $page_name != 'edit_article' ||  (isset($get_article_details['allow_pagination']) && $get_article_details['allow_pagination'] == 1 ) ) echo  "checked"; ?> />-->
			...
			<div class="padding-bottom-5">
				<input type="checkbox"  name="cbAllowAmp" id="cbAllowAmp"  <?php if(set_value("cbAllowAmp") == 'on' || $page_name != 'edit_article' ||  (isset($get_article_details['amp_status']) && $get_article_details['amp_status'] == 1 ) ) echo  "checked"; ?> />
				<label for="cbAllowPagination" class="margin-bottom-0">Allow AMP</label>
            </div>
            </div>
            </div>
         <div class="article_attribute">
...
<input type="hidden" id="current_image_popup" value="" />
 ...
 <div id="preview_article_popup_container"  class="container" style="display:none;">
          ...
          <form  name="ImageForm" id="ImageForm" action="<?php echo base_url().folder_name; ?>/article_image/image_upload" method="POST" enctype="multipart/form-data">
            ...
            <span id="embed_mark" style="float: left;margin-top: 1%;margin-left: 3%;display:none;"><input type="checkbox" style="width: auto;margin-right: 5px;margin-top: 2px;" name="embed_mark">WaterMark</span>
 ...
 $.ajax({
   ...
   if (data.indexOf("LIVE | Status") >= 0) 
	...
	<?php } ?>
		...
		$("#main_content").css("margin-top","136px");
...
// IE & DM Differents
	...
	jqs("#txtCity").keyup(function()
	{
		...
		*/
			...
			head_line = encodeURIComponent($('#article_head_line_id1').val());
...
function add_pager(){
if($("#cbAllowPagination").is(":checked")==true){
	toastr.error("Uncheck 'Allow Pagination' to add manual pagination");
}else{
	body_text = CKEDITOR.instances.body_text.getData();
	CKEDITOR.instances['body_text'].insertText('{pagination-pagination}');
	//CKEDITOR.instances.body_text.setData(body_text+'{pagination-pagination}');
	toastr.success("Pagination Added");
}
...
$(document).ready(function(e){
	...
	$('.translate-content').on('click' , function(e){
		...
		if(content!=''){
			...
			surl += "&source=EN";
			surl += "&target=TA";
			surl += "&q=" +escape(content);
			$.get(surl, function (data, status) {
				//console.log(surl);
				CKEDITOR.instances.body_text.setData(data.data.translations[0].translatedText);
				toastr.success('Content Translated Successfully');
			});
		}else{
