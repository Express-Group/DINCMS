	...
	$(document).ready(function()
	{
		...
		$("#frmTopicMaster").validate({
			...
			{			
				...
				{ 
					//required: true,
					required: function() { CKEDITOR.instances.txtDescription.updateElement();}
				},
			},
			messages: 
			{
				...
				txtDescription:
				{
					required: "Please enter column description",
				},
			},
			errorPlacement: function (error, element)
			{
				if(element.attr("name") == 'txtDescription')
				{ 
		...
		$("#btnSave").click(function() 
		{
			if($("#frmTopicMaster").valid())
			{
				...
				var deptid=$('#txthiddenid').val();
					...
					url:"<?php echo base_url(); ?>dmcpan/topic_manager/check_Topicname",
...
<div class="Container">
	<div class="BodyWhiteBG">
		<form name="frmTopicMaster" id="frmTopicMaster" method="post" action="<?php echo base_url()."dmcpan/topic_manager/topic_details";?>" enctype="multipart/form-data" >
			<div class="BodyHeadBg Overflow clear">
				...
				<p class="FloatRight save-back save_margin"> <a class="FloatLeft back-top" href="<?php echo base_url()."dmcpan/topic_manager";?>"><i class="fa fa-reply fa-2x"></i></a>
			...
			<div class="poll_content role-depart">
				<div class="role-dept">
					<div class="role-first">
						<div class="qnsans">
							<div class="qns2">
								<label class="question">Column Name</label>
							</div>
							<div class="ans">
								<input type="text" name="txtTopicName" maxlength="50" id="txtTopicName" class="tb_style2 box-shad box-shad1" value="<?php if(isset($op_Topicname)){ echo $op_Topicname ;}else{echo set_value('txtTopicName');}?>"  >
						...
						<div class="qnsans">
							...
							<div class="ans">
								<!--<textarea name="txtDescription" id="txtDescription" class="tb_style2 box-shad box-shad1"><?php if(isset($op_description)){ echo $op_description ;}else{echo set_value('txtDescription');}?></textarea>-->
								
								<textarea class="ckeditor" name="txtDescription" id="txtDescription"><?php if(isset($op_description)){ echo $op_description ;}else{echo set_value('txtDescription');}?></textarea>
								<p id="description_error" style="color:#F00"></p>
							</div>
