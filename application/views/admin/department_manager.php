...
<div class="Container">
	<div class="BodyWhiteBG">
		...
		{ ?>
             <p class="FloatRight SaveBackTop remoda1-bg"><a href="<?php echo base_url();?>dmcpan/department_manager/department_form_view" type="button" class="btn-primary btn"><i class="fa fa-plus-circle"></i>Add New</a></p>
             <?php }?>
	...
	function delete_department(id)
		{
			...
			if(r==true){
			window.location.href="<?php echo base_url() ?>dmcpan/department_manager/department_delete/"+id;
		}
	}
</script>
<script>
	...
	$('#example').dataTable( 
{
    ...
    .append($('<td class="BackArrow"><a href="<?php  echo base_url(); ?>dmcpan/department_manager" data-toggle="tooltip" title="Back to list"><i class="fa fa-reply fa-2x"></i></a></td>'));
		   }
		   else
		   {
		...
		"ajax": {
            "url": "<?php echo base_url(); ?>dmcpan/department_manager/department_datatable",
			"type" : "POST",
			"data" : {
