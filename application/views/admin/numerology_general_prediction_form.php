...
<script type="text/javascript" src="<?php echo base_url();?>js/numerology_general_predictions.js"></script>
...
{
	$title1 = 'Numerology General predictions - Edit';
}else{ $title1 = 'Numerology General predictions - Create';}
...
<div class="Container">
	<div class="BodyWhiteBG">
		...
		<?php } ?>
		<form name="generalPredictions_form" id="generalPredictions_form" action="<?php echo base_url(); ?>dmcpan/numerology_general_prediction/add_general_predictions" method="post" enctype="multipart/form-data">
			<div class="BodyHeadBg Overflow clear">
				...
				<a class="FloatLeft back-top" href="<?php echo base_url(); ?>dmcpan/numerology_general_prediction"><i class="fa fa-reply fa-2x"></i></a>
	...
	<script type="text/javascript" src="<?php echo base_url(); ?>js/jquery.remodal.js"></script>
	 <script language="javascript">
		...
		$("#preview_id").click(function() {
			...
			var postdata = {"body_text" :body_text,"number":number,"menu_name":'<?php echo 'Numerology General Prediction'; ?>'};
			$.ajax({
