...
<tr>
                      ...
                      <td class="GalleryNameCount PositionRelative">
                        ...
                        <textarea readonly class="ckeditor" id="txtgalleryname" name="txtgalleryname"><?php echo set_value('txtgalleryname'); ?><?php  if(isset($get_gallery_details['title'])) echo $get_gallery_details['title']; ?></textarea>
					 ...
					 <span id="gallery_name_error"></span>
                      ...
                      <td> <input type="text" class="box-shad input_height WidthPercentage" <?php if(isset($get_gallery_details['url_title'])) { echo "readonly"; } ?> name="txtUrlTitle" id="txtUrlTitle"  value="<?php if(isset($get_gallery_details['content_id'])) echo $get_gallery_details['url_title']; echo set_value('txtUrlTitle'); ?>"/>
		...
		<textarea readonly class="ckeditor" id="txtSummary"  name="txtSummary"><?php if(isset($get_gallery_details['summaryHTML'])) echo $get_gallery_details['summaryHTML']; echo set_value('txtSummary'); ?></textarea></td>
                              ...
                              <div align="left">
                               ...
                               <div class="w2ui-field" id="Published">
                                 ...
                                 <div align="left">
                                    ...
                                    <input disabled type="text" name="txtByLine" id="txtByLine" value="<?php if(isset($select_author) && $select_author != "") {  echo $select_author; } echo set_value('txtbyline'); ?>"  />
     ...
     <tr>
      ...
      <?php echo form_error('txtmetadescription'); ?>
                   ...
                   <ul class="MetaDescriptionList">
                     <li>
                   <input disabled type="checkbox" id="cbNoIndex" name="cbNoIndex" <?php if(set_value("cbNoIndex") == 'on' ||   (isset($get_gallery_details['Noindexed']) && $get_gallery_details['Noindexed'] == 1 ) ) echo  "checked"; ?> />
                <label class="include_label" >No Index</label>
                    </li>
                    <li>
                  <input disabled type="checkbox" id="cbNoFollows" name="cbNoFollows" <?php if(set_value("cbNoFollows") == 'on' ||   (isset($get_gallery_details['Nofollow']) && $get_gallery_details['Nofollow'] == 1 )  ) echo  "checked"; ?> />
      ...
      <td  valign="top"><input readonly type="text" class="input_height box-shad1 FloatNone" name="txtCanonicalUrl"  value="<?php echo set_value('txtCanonicalUrl'); ?><?php if(isset($get_gallery_details['Canonicalurl'])) echo $get_gallery_details['Canonicalurl']; ?>" />
        ...
        <li style="display:none;" class=""><a id="section_href" href="#view2" >Multi Section Mapping</a></li>
          ...
          <section class="GalleryTabsContent">
            ...
            <div class="addFiles margin-top-0 add_files_new">
                  <a href="#" style="display:none;" data-remodal-target="modal1" id="BrowsePopup" class="fileUpload btn btn-primary">Browse</a>
				</div>
			</div>	
			...
			<table width="100%" cellspacing="0" class="display article_table dataTable no-footer gallerydatatable" id="sort" role="grid" aria-describedby="link_preview_table_info" style="width: 100%;"> 
				<thead id="link_preview_head" style="" >
					...
					<th style="display:none;" class="sorting_disabled" tabindex="0" aria-controls="link_preview_table" rowspan="1" colspan="1" style="width: 179px;" aria-label="Action: activate to sort column ascending">Action</th>
			...
			?>
				...
				$Physical_array = explode('.', $values->image_name);
				 ?>
						...
						<td><div align='center'><textarea readonly style='width:300px; text-align:center;'  name="image_caption" id="image_caption_id" maxlength=200 rel="<?php echo $Count; ?>" value="" ><?php echo str_replace('"',"'",$values->caption); ?></textarea></div></td>
						
						<td><div align='center'><textarea  readonly style='width:300px; text-align:center;'  name="image_alt" id="image_alt_id" maxlength=200 rel="<?php echo $Count; ?>"  ><?php echo str_replace('"',"'",$values->alt_tag); ?></textarea></div></td>
						
						<td><div align='center'><input readonly type="textbox" style='width:100%; text-align:center;'  name="physical_name" id="physical_name" maxlength=80 rel="<?php echo $Count; ?>" physical_extension="<?php echo $Physical_array[1]; ?>" value='<?php echo str_replace("'",'"',$values->physical_name); ?>' temp_id="<?php echo $values->imageid; ?>" /></div><span class='error' id="error_<?php echo $values->imageid; ?>"></span></td>
						
						<td style="display:none;"><div class='article_table_delete'>  <a  id='edit_image' rel='<?php echo $values->imageid; ?>' href='javascript:void(0);' class='button tick tooltip-2' data-toggle='tooltip'   title='Edit' data-original-title='Edit'><i class='fa fa-pencil'></i></a><a class='button cross' href='javascript:void(0)' data-toggle='tooltip'   title='Delete' data-original-title='Delete'  index_value="<?php echo $Count; ?>" id='deletetempimage' rel='<?php echo $values->imageid; ?>' ><i class='fa fa-trash-o'></i></a></div></td>
						</tr>
				 <?php $Count++; }  ?>
