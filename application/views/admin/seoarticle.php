...
<ul  class="tabs Article-Tab">
            ...
            <li style="display:none;" class="" id="section_div"><a id="section_href" href="#view2">Multi Section Mapping</a></li>
            <li style="display:none;" class="" id="related_div"><a id="related_href" href="#view3">Related Content</a></li>
        </ul>
...
<textarea readonly class="ckeditor"  id="article_head_line_id" name="txtArticleHeadLine"><?php echo set_value('txtArticleHeadLine'); ?><?php  if(isset($get_article_details['title'])) echo $get_article_details['title']; ?></textarea>
            ...
            <input type="text" class="box-shad1 full-width" id="txtUrlTitle" name="txtUrlTitle"  <?php if(isset($get_article_details['url_title'])) { echo "readonly"; } ?>  value="<?php if(isset($get_article_details['url_title'])) echo htmlentities($get_article_details['url_title']); echo set_value('txtUrlTitle'); ?>" />
			 ...
			 <label>URL Structure : <a href="<?php  echo BASEURL.$get_article_details['url']."?page=preview"; ?>"><?php  echo BASEURL.$get_article_details['url']; ?></a></label>
			 <?php } ?>
				
            <label>Main Section<sup>*</sup></label>
            <div class="w2ui-field">

  <select disabled name="ddMainSection" class="controls" id="main_section_id" section_data="<?php echo $select_parent_name; ?>" Value="<?php echo set_value('ddMainSection'); ?><?php echo @$get_article_details['Section_id']; ?>">
...
<option id="MainSectionOption" style="color:#933;font-size:18px;"<?php /* if($mapping['Section_landing'] == 1 && $mapping['Sectionname'] != 'Columns' && $mapping['Sectionname'] != 'Magazine' && $mapping['Sectionname'] != 'The Sunday Standard' && $mapping['Sectionname'] != 'Editorials' ) { ?> disabled='disabled' <?php } */ ?>  class="blog_option" <?php if(set_value("ddMainSection") == $mapping['Section_id'] || (isset($get_article_details['content_id']) && $get_article_details['Section_id'] == $mapping['Section_id']  ) || ($page_name != 'edit_article' && $this->session->userdata('main_section') == $mapping['Section_id'] && folder_name == 'dmcpan')) { echo  "selected"; $section_bool=false; } ?> sectoin_data="<?php echo @$mapping['Sectionname']; ?>" rel="<?php echo @$mapping['LinkedToColumnist']; ?>"  value="<?php echo $mapping['Section_id']; ?>" url_structure="<?php echo mb_ucwords(str_replace("-"," ",str_replace("/"," > ",trim(@$mapping['BreadCrumb'])))); ?>" author_name="<?php echo (isset($mapping['AuthorID']) && $mapping['AuthorID'] != '')? get_authorname_by_id($mapping['AuthorID']) : '' ; ?>"><?php echo strip_tags($mapping['Sectionname']); ?></option>
 ...
 <?php echo form_error('ddMainSection'); ?>
  ...
  <input disabled type="checkbox" name="cbSectionPromotion" id="SectionPromotion" class="HeightAuto"  <?php if((set_value("cbSectionPromotion") == 'on' && $page_name != 'edit_article') ||   (isset($get_article_details['section_promotion']) && $get_article_details['section_promotion'] == 1 ) ) echo  "checked"; ?>  > Section promotion
...
<textarea readonly class="ckeditor" id="summary"  name="txtSummary"><?php if(isset($get_article_details['summaryHTML'])) echo $get_article_details['summaryHTML']; echo set_value('txtSummary'); ?></textarea>
...
<textarea readonly class="ckeditor" id="body_text" name="txtBodyText"><?php if(isset($get_article_details['ArticlePageContentHTML'])) echo $get_article_details['ArticlePageContentHTML']; echo set_value('txtBodyText'); ?></textarea>
 ...
 <span id="article_body_error"></span>
          ...
          <p>Preview</p>
			...
			<label>Caption :</label>
			<input readonly type="text" id="home_image_caption"   name="home_image_caption" maxlength=200 value="<?php echo htmlentities(@$get_article_details['homepageimageid']['temp_caption']);   ?>" class="margin-top-5 WidthFull" />
			<label>Image Alt :</label>
			<input readonly type="text" id="home_image_alt"  name="home_image_alt" maxlength=200 value="<?php echo htmlentities(@$get_article_details['homepageimageid']['temp_alt']);   ?>" class="margin-top-5 WidthFull">
			<label>Image Name :</label>
			<input readonly type="text" id="home_physical_name"  name="home_physical_name" maxlength=100  physical_extension="<?php echo @$get_article_details['homepageimageid']['physical_extension'];   ?>" value="<?php echo @$get_article_details['homepageimageid']['physical_name'];   ?>" class="margin-top-5 WidthFull" <?php if(isset($get_article_details['homepageimageid']['temp_id'])) { ?> readonly <?php } ?>>
          </div>
        ...
        <p style="">Preview</p>
		   ...
		   <label>Caption :</label>
		   <input readonly type="text" value="<?php echo htmlentities(@$get_article_details['Sectionimageid']['temp_caption']);   ?>" name="section_image_caption"  id="section_image_caption" maxlength=250  class="margin-top-5 WidthFull" />
		   <label>Image Alt :</label>
		   <input readonly type="text" value="<?php echo htmlentities(@$get_article_details['Sectionimageid']['temp_alt']);   ?>" name="section_image_alt"    class="margin-top-5 WidthFull"  id="section_image_alt" maxlength=250   />
		   <label>Image Name :</label>
			<input readonly type="text" id="section_physical_name"  name="section_physical_name" maxlength=100 physical_extension="<?php echo @$get_article_details['Sectionimageid']['physical_extension'];   ?>"  value="<?php echo @$get_article_details['Sectionimageid']['physical_name'];   ?>" class="margin-top-5 WidthFull" <?php if(isset($get_article_details['Sectionimageid']['temp_id'])) { ?> readonly <?php } ?>>
          </div>
        ...
        <p style="">Preview</p>
		  ...
		  <label>Caption :</label>
		   <input readonly type="text" value="<?php echo htmlentities(@$get_article_details['articleimageid']['temp_caption']);   ?>" name="article_image_caption"  maxlength=200  class="margin-top-5 WidthFull" id="article_image_caption" />
		   <label>Image Alt :</label>
		   <input readonly type="text" value="<?php echo htmlentities(@$get_article_details['articleimageid']['temp_alt']);   ?>" name="article_image_alt"   class="margin-top-5 WidthFull" maxlength=200 id="article_image_alt" />
		   <label>Image Name :</label>
			<input  readonly type="text" id="article_physical_name"  name="article_physical_name" maxlength=80 physical_extension="<?php echo @$get_article_details['articleimageid']['physical_extension'];   ?>"  value="<?php echo @$get_article_details['articleimageid']['physical_name'];   ?>" class="margin-top-5 WidthFull"  <?php if(isset($get_article_details['articleimageid']['temp_id'])) { ?> readonly <?php } ?>>
          </div>
        </div>
...
<label>Agency<sup>*</sup></label>
  <select disabled name="ddAgency"  class="controls" id="agency_id"  >
...
-->
 ...
 <input readonly  type="text" name="txtByLine" id="txtByLine"  value="<?php if(isset($select_author) && $select_author != "") {  echo htmlentities($select_author); } echo set_value('txtbyline'); ?>" maxlength="50" />
    ...
    <?php echo form_error('ddByLine'); ?>
            ...
            <div class="w2ui-field">
<label>Country</label>
  <select disabled name="ddCountry"  class="controls" id="country_id" value="<?php echo set_value('ddCountry'); ?>">
    <option value="">-Select-</option>
...
<!--
  <select name="ddState"  class="controls" id="state_id" value="<?php echo set_value('ddState'); ?>" >
   ...
   <input readonly type="text" name="txtState" id="txtState" value="<?php if(isset($select_state) && $select_state != "") {  echo $select_state; } echo set_value('txtState'); ?>"  />
    ...
    <?php echo form_error('ddState'); ?>
		...
		<input readonly type="text" name="txtCity" id="txtCity" value="<?php if(isset($select_city) && $select_city != "") {  echo $select_city; } echo set_value('txtCity'); ?>"  />
    ...
    <?php echo form_error('ddCity'); ?>
           ...
           <input disabled type="checkbox"  name="cbAllowComments" id="cbAllowComments"  <?php if(set_value("cbAllowComments") == 'on' || $page_name != 'edit_article' ||  (isset($get_article_details['Allowcomments']) && $get_article_details['Allowcomments'] == 1 ) ) echo  "checked"; ?> />
            <label for="cbAllowComments" class="margin-bottom-0">Allow Comments</label>
            </div>
			
			  <div class="padding-bottom-5">
           <input disabled type="checkbox"  name="cbAllowPagination" id="cbAllowPagination"  <?php if((isset($get_article_details['allow_pagination']) && $get_article_details['allow_pagination'] == 1 ) ) echo  "checked"; ?> />
         ...
         <div class="article_attribute">
          ...
          <!--  <p>Social Meta Tag</p>
            ...
            <p>Social Meta Tag</p>
            <div class="padding-bottom-5">
            <input disabled type="checkbox" id="cbNoIndex" name="cbNoIndex" <?php if(set_value("cbNoIndex") == 'on'  ||   (isset($get_article_details['Noindexed']) && $get_article_details['Noindexed'] == 1 ) ) echo  "checked"; ?> />
            <label for="cbNoIndex">No Index</label>
            </div>
            <div class="padding-bottom-5">
            <input disabled type="checkbox" id="cbNoFollows" name="cbNoFollows" <?php if(set_value("cbNoFollows") == 'on' ||   (isset($get_article_details['Nofollow']) && $get_article_details['Nofollow'] == 1 ) ) echo  "checked"; ?> />
            <label for="cbNoFollows">No Follow</label>
            </div>
            <label>Canonical URL</label>
            <input readonly  type="text" class="input_height box-shad1" name="txtCanonicalUrl"  value="<?php echo set_value('txtCanonicalUrl'); ?><?php if(isset($get_article_details['Canonicalurl'])) echo $get_article_details['Canonicalurl']; ?>" />
            </div>
            </div>
