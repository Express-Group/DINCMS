...
$Canonicalurl     = (strtolower($section_details['URLSectionStructure'])=='home')? base_url().'amp/' : base_url().'amp/'.$section_details['URLSectionStructure'];//($section_details['Canonicalurl']!='') ? $section_details['Canonicalurl'] : '';
    ...
    OneSignal.push(["init", {
      ...
      notifyButton: {
	   ...
	   promptOptions: {
        ...
        actionMessage: "We'd like to show you notifications for the latest news and updates from www.dinamani.com",
