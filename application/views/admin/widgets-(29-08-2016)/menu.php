...
<li><a class="AllTopic" href="<?php echo base_url()."center-page-articles"; ?>">கட்டுரைகள்</a></li>
...
<!--<li><a class="AllTopic" href="<?php echo base_url()."specials/indha-naalil-andru"; ?>">இந்த நாளில்...</a></li>-->
