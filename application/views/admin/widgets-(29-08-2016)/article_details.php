...
<div class="row">
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ArticleDetail">
    ...
    <!--<p class="ArticlePublish margin-bottom-10">--> மாற்றம் செய்த நாள் : <span><?php echo $last_updated_date;?></span><?php  if($content_type_id=='1'){ ?>&nbsp;&nbsp;|&nbsp;&nbsp; <span class="FontSize" id="incfont" data-toggle="tooltip" title="பெரிதாக்கு">அ+</span><span class="FontSize" id="resetMe" data-toggle="tooltip" title="மீட்டமைக்க">அ&nbsp;</span><span class="FontSize" id="decfont" data-toggle="tooltip" title="சிறிதாக்கு">அ-</span> <span id="print_article">&nbsp;&nbsp;|&nbsp;&nbsp;<i class="fa fa-print"></i></span><?php } ?></p>
...
<?php
	...
	{
	$imagedetails = getimagesize(image_url . imagelibrary_image_path.$content_det['article_page_image_path']);
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 features Detail-play">
  ...
  <div class="slide GalleryDetail GalleryDetailSlide" style="width:100% !important">
    ...
    <?php foreach($get_gallery_images as $gallery_image){ 
				  ...
				  if (getimagesize(image_url . imagelibrary_image_path . $Image600X390) && $Image600X390 != '')
					{
				  $imagedetails = getimagesize(image_url . imagelibrary_image_path.$gallery_image['gallery_image_path']);
					$imagewidth = $imagedetails[0];
                    $imageheight = $imagedetails[1];
