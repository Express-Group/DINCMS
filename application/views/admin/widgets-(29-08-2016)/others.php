		     ...
		     {				
					foreach($widget_contents as $get_content)
					{
						...
						$show_image="";
							...
							$section_name  = end($section_name_split);
							...
							$display_title = preg_replace('/<p[^>]*>(.*)<\/p[^>]*>/i', '$1',$custom_title);
							 ...
							 $show_simple_tab .= '<div class="other1"><a  href="'.$live_article_url.'"><img data-lazy="'.$show_image.'" title = "'.$imagetitle.'" alt = "'.$imagealt.'"></a>';
							 $show_simple_tab .= '<h5 class="subtopic"><a  href="'.$sectionURL.'">'.$section_name.'</a></h5>';				
