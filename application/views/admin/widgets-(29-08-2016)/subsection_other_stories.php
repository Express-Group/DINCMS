...
else
{
	...
	{
		$widget_instance_contents_auto = $this->widget_model->get_all_available_articles_auto($subsec_leadstory_max_article, $page_section_id , 1 , $content['mode']);
...
$show_simple_tab.=	'<div class="grid-list-icon"><h4>தற்போதைய செய்திகள்</h4>';
//}else{
