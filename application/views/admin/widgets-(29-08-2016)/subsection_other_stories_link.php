...
$show_simple_tab .=' <div class="row">
						...
						<div class="Other-Story" '.$widget_bg_color.'><div class="grid-list-icon">';
						
if($widget_custom_title=="")
{
	$show_simple_tab.=	'<h4>தற்போதைய செய்திகள்</h4>';
}
else
{
	...
	foreach($widget_contents as $key_value => $get_content)
	{
		...
		if($count <= 3)
		{
		   ...
		   $show_simple_tab.= '<div class="row">'; 
				...
				$show_simple_tab.= '<img class="group list-group-image" src="'.$dummy_image.'" data-src="'.$show_image.'" title = "'.$imagetitle.'" alt = "'.$imagealt.'">';
				 
				$show_simple_tab.= '<div class="caption">
