...
$sec_id= $widget_instancemainsection[0]['Section_ID'];*/

//echo $sec_id;exit;
/*if($sec_id!='')
{
 $section = $this->widget_model->get_sectionname($sec_id); 
}else{ $section=''; }*/
...
if(count($widget_contents)>0)
{
	foreach($widget_contents as $get_content)
	{
		...
		if($i==1)
		{
			...
			$show_simple_tab.='<figcaption class="gal-sub-des gal-sub-des-1">'.$display_title .'</figcaption>';
			$show_simple_tab.= '</div>
			</div>';
		}
		if($i==2 )
...
$show_simple_tab .='<div class="margin-bottom-10"  '.$widget_bg_color.'>'.no_articles.'</div>';
																	...
																	//$show_simple_tab.='
//																	<div class="arrow">
//																	<a href="'.$widget_section_url.'" onclick="call_url('.$section_landing.')" class="landing-arrow">  
//																	<span class="arrow-span"> </span>
//																	<div class="arrow-rightnew"></div>
//																	</a></div> ';	 
