<div class="row">
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="ask_prabu">
			<h4><a href="<?php echo base_url(); ?>Ask-Prabhu">Ask Prabhu</a></h4>
			<table>
				<tbody>
					<tr>
						...
						<td><a href="<?php echo base_url();?>Ask-Prabhu" class="editorial"><strong>Prabhu Chawla</strong><br>
			...
			<div class="ask_column">
				<h5><a href="<?php echo base_url();?>Columns/Prabhu-Chawla" class="editorial"> <strong>Column:</strong> Power And Politics</a></h5>
			</div>
		</div>
	</div>
</div>
