...
$show_image	= image_url. imagelibrary_image_path.'logo/dinamani_logo_600X390.jpg';
	...
	$summary  = preg_replace('/<p[^>]*>(.*)<\/p[^>]*>/i', '$1',$custom_summary);  //to remove first<p> and last</p>  tag
															...
															if($i == 1)
															{
																...
																$show_simple_tab.='<article class="img-boder">
																<figure><a href="'.$live_article_url.'" class="article_click" ><img src="'.$dummy_image.'" data-src="'.$show_image.'" title = "'.$imagetitle.'" alt = "'.$imagealt.'"></figure>														<figcaption class="lead-news">
																<h4>'.$display_title.'</h4>';
		...
		$show_simple_tab .='<div class="arrow"><a href="'.$widget_section_url.'" class="landing-arrow"><div class="arrow-span"> </div><div class="arrow-rightnew"></div></a></div>';
															 ...
															 { 
																...
																<div class="arrow-rightnew"></div></a></div>';
																}	
																}
