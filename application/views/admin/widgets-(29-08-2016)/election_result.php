...
$show_simple_tab = "";
$show_simple_tab .= '<div class="row"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ArticleDetail ArticleDetailContent"> <div class="election-result">';
	...
	if(count($widget_contents) > 0 ){	
		...
		{	
			...
			if($count == 1){
				...
				$show_simple_tab .= '<p class="election-title">' . $display_title .'</p>';
