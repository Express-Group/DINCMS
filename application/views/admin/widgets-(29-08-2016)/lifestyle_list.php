...
$show_simple_tab	.= '</div>';
				...
				$show_simple_tab .='	  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 first-top lifestyle-lead">
					   <div class="health-lead margin-bottom-10">
					   <div class="top-news" '.$widget_bg_color.'>';
	...
	/*	if( $custom_summary == '')
		...
		$summary  = preg_replace('/<p[^>]*>(.*)<\/p[^>]*>/i', '$1',$custom_summary);  //to remove first<p> and last</p>  tag */
															...
															//  Assign article links block ends hers
																...
																if($i==1)
																{
																	$show_simple_tab .='<ul class="health-list">';
																}
