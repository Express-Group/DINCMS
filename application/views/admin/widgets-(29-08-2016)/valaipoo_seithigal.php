...
<div '.$widget_bg_color.'>
<div class="cartoon valipoo-seithigal">
<div class="row">
...
$add_sub_class='box-one child-box3 cook';
}elseif($j==1){
$add_class='box-botton valaipoo-title';
$add_sub_class='box-one box-one3 valaipoo-summary';	
}
...
{
if (getimagesize(image_url . imagelibrary_image_path  . $custom_original_image_path) )
{																
$custom_show_image 	= image_url.imagelibrary_image_path. $custom_original_image_path;																		
}
else 
{
$custom_show_image	= image_url. imagelibrary_image_path.'logo/custom120x180.jpg' ;
}
$custom_dummy_image		= image_url. imagelibrary_image_path.'logo/custom120x180.jpg';
...
if($j==0){
$show_simple_tab .='<div id="features"><div class="slider single-item cartoon-sec valaipoo-seithigal">
<div><a href="'.$live_article_url.'" class="article_click"> <figure> <img  src="'.$custom_dummy_image.'" data-src="'.$custom_show_image.'"   title = "'.$custom_imagetitle.'" alt = "'.$custom_imagealt.'"></figure></a><figcaption><p class="font-size">'.$display_title.'</p></figcaption></div>';
}elseif($j==1){
...
{
if($j==0){
$show_simple_tab .='<div><a href="'.$live_article_url.'" class="article_click"> <figure><img  src="'.$custom_dummy_image.'" data-src="'.$custom_show_image.'"   title = "'.$custom_imagetitle.'" alt = "'.$custom_imagealt.'"></figure></a><figcaption><p class="font-size">'.$display_title.'</p>
</figcaption>
</div>';
}elseif($j==1){
$show_simple_tab .='<li>
