   ...
   <?php /*?> Published: <span><?php echo $published_date;?></span>&nbsp;&nbsp;|&nbsp;&nbsp;
     <?php  if($content_type_id!= 1){ ?>
      ...
      <!--</p>
       ...
       <p class="ArticlePublish margin-bottom-10">--> மாற்றம் செய்த நாள் : <span><?php echo $last_updated_date;?></span><?php  if($content_type_id=='1'){ ?>&nbsp;&nbsp;|&nbsp;&nbsp;
...
<?php
	...
	{
	$imagedetails = getimagesize(image_url . imagelibrary_image_path.$content_det['ImagePhysicalPath']);
...
<div class="gallery_detail_skin">
  ...
  <div class="slide GalleryDetail GalleryDetailSlide" style="width:100% !important">
    ...
    <?php foreach($get_gallery_images as $gallery_image){ 
				  ...
				  if (getimagesize(image_url . imagelibrary_image_path . $Image600X390) && $Image600X390 != '')
					{
				  $imagedetails = getimagesize(image_url . imagelibrary_image_path.$gallery_image['ImagePhysicalPath']);
					$imagewidth = $imagedetails[0];
                    $imageheight = $imagedetails[1];
