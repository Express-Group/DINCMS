                                                           ...
                                                           <figcaption><h4>'.$display_title.'</h4></figcaption>
																...
																{ 
																	...
																	//$show_simple_tab.='</div>';
																		...
																		<a href="'.$widget_section_url.'" class="landing-arrow">                                                                        <span class="arrow-span" style="background:#fff;"> </span>
																		<div class="arrow-rightnew" style="border-left:8px solid #fff;"></div>
																		</a></div>';
																		}
