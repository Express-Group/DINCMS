...
<!--<script src="<?php echo image_url; ?>js/jquery-1.11.3.min.js" type="text/javascript"></script>
...
--><link href="<?php echo image_url; ?>css/admin/tag/bootstrap-tagsinput.css" rel="stylesheet" type="text/css" />
...
<!--<script src="<?php echo image_url; ?>js/bootstrap/bootstrap.js"></script>-->
<!--<script src="<?php echo image_url; ?>js/tags/angular.js"></script>
--><script src="<?php echo image_url; ?>js/tags/bootstrap-tagsinput.js"></script>
<!--<script src="<?php echo image_url; ?>js/tags/bootstrap-tagsinput-angular.js"></script>
--><!--<script src="<?php echo image_url; ?>js/tags/typeahead.js"></script>-->
  
<script type="text/javascript" src="<?php echo image_url; ?>js/jquery.dataTables.js"></script>
<!--<script type="text/javascript" src="<?php echo image_url; ?>js/w2ui-fields-1.0.min.js"></script>
-->
<script>
function uncheck()
{
...
<div class="Overflow DropDownWrapper PanchangamWrapper">
	...
	<form id="negativeKey_form" name="negativeKey_form" onsubmit="return false" method="post">
        <table id="example" class="display" cellspacing="0" width="100%" border="0" cellpadding="0" style="margin-top:10px;">
            <thead>
                <tr>
                    <th>Keyword</th>
                    <th>Created On</th>
