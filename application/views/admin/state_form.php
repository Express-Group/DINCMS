		...
		$("#btnSave").click(function() 
		{
			if($("#frmstateMaster").valid())
			{
				...
				var stateid=$('#txthiddenid').val();
					...
					url:"<?php echo base_url(); ?>dmcpan/state_manager/check_statename",
...
<form name="frmstateMaster" id="frmstateMaster" method="post" action="<?php echo base_url()."dmcpan/state_manager/state_details";?>" enctype="multipart/form-data" >
...
<p class="FloatRight save-back save_margin">
 <a class="FloatLeft back-top" href="<?php echo base_url()."dmcpan/state_manager";?>"><i class="fa fa-reply fa-2x"></i></a>
