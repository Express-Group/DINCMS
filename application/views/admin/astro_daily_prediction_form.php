...
<div class="Container">
	<div class="BodyWhiteBG">
		...
		<?php } ?>
		<form name="dailyPredictions_form" id="dailyPredictions_form" action="<?php echo base_url(); ?>dmcpan/astro_daily_prediction/add_daily_predictions" method="post" enctype="multipart/form-data">
			<div class="BodyHeadBg Overflow clear">
				...
				<a class="FloatLeft back-top" href="<?php echo base_url(); ?>dmcpan/astro_daily_prediction"><i class="fa fa-reply fa-2x"></i></a>
...
<p id="already_error" style="color:#F00"></p>
									...
									<div class="panchangam-section1">
										<h4 class="ColorTheme">இன்றைய பலன்<span id="mandatory">*</span></h4>
