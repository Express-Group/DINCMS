		...
		$("#btnSave").click(function() 
		{
			if($("#frmdepartmentMaster").valid())
			{
				...
				var deptid=$('#txthiddenid').val();
					...
					url:"<?php echo base_url(); ?>dmcpan/department_manager/check_departmentname",
...
<form name="frmdepartmentMaster" id="frmdepartmentMaster" method="post" action="<?php echo base_url()."dmcpan/department_manager/department_details";?>" enctype="multipart/form-data" >
...
<p class="FloatRight save-back save_margin">
 <a class="FloatLeft back-top" href="<?php echo base_url()."dmcpan/department_manager";?>"><i class="fa fa-reply fa-2x"></i></a>
