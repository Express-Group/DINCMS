...
{
	$title1 = 'Numerology Yearly Prediction- Edit';
}else{ $title1 = 'Numerology Yearly Prediction - Create';}
...
<div class="Container">
	<div class="BodyWhiteBG">
		...
		<?php } ?>
		<form name="yearlyPredictions_form" id="yearlyPredictions_form" action="<?php echo base_url(); ?>dmcpan/numerology_yearly_prediction/add_yearly_predictions" method="post" enctype="multipart/form-data">
			<div class="BodyHeadBg Overflow clear">
				...
				<a class="FloatLeft back-top" href="<?php echo base_url(); ?>dmcpan/numerology_yearly_prediction"><i class="fa fa-reply fa-2x"></i></a>
	...
	<script type="text/javascript" src="<?php echo base_url(); ?>js/jquery.remodal.js"></script>
	 <script language="javascript">
		...
		$("#preview_id").click(function() {
			...
			var postdata = {"body_text" :body_text,"date": date,"number":number,"menu_name":'<?php echo 'Numerology Yearly Prediction'; ?>'};
			$.ajax({
