	...
	$("#btnLoginSubmit").click(function()
	{
		if($("#loginPage_form").valid())
		{
			...
			$.ajax({
					...
					url: "<?php echo base_url(); ?>dmcpan/clog/check_username",
					...
					success:function(data)
					{
						if(data == "success")
						{
							window.location.replace("<?php echo base_url();?>dmcpan/");
						}
            ...
            <div class="login">
                <form action="#" name="loginPage_form" id="loginPage_form" onsubmit="return false" enctype="multipart/form-data" method="post">
                    <fieldset class="LoginForm">
                        ...
                        <p class="FloatLeft ForgotPass"> <a href="<?php echo base_url(); ?>dmcpan/clog/forgot_pwd">Forgot Password?</a></p>
                    </fieldset>
                </form>
            </div>
        </div>  
