<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBmm4E74NnsoNTqRahoTfqbNvmB1mAh89A&language=ta" async defer></script>
<style>
.district-title{background: #1b91ce;padding: 5px 5px 5px;font-size: 16px;font-weight: 700 !important;float: left;width: 100%; color: #fff !important;margin-bottom: 0;}
...
.district-content-<?php echo $content['widget_values']['data-widgetinstanceid'] ?> .WidthFloat_L .col-lg-2{padding: 0 5px 0 3px;}
	...
	if($j==0){
		...
		if(count($widget_contents)>0){
			...
			foreach($widget_contents as $get_content){
				...
				$section = $domain_name.$get_section['URLSectionStructure'];
