...
$show_simple_tab.='<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 cine-head">';
...
$w = $w+1;						  
			...
			<a href="'.$sectionURL.'" class="landing-arrow">மேலும் <i class="fa fa-arrow-right" style=" color: #071c47;"></i></a></div>';
