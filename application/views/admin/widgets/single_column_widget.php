...
if(strtolower(strip_tags($widget_custom_title)) !='none'){
	$show_simple_tab	   .=	'<h4 class="virivana-title-h4 VideoGallery-title"><p>'.$widget_title.'</p></h4>';	
}			
...
if(count($widget_instance_contents)>0){			
	foreach($widget_instance_contents as $get_content){
		...
		$show_simple_tab.= '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 VideoGallerySplit1">';
