...
$show_simple_tab    .='<div class="row">
                       <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 border  margin-bottom-10">
					   <div class="health-lead " 	'.$widget_bg_color.'>
                       <div class="top-news">';
...
$show_image	= image_url. imagelibrary_image_path.'logo/dinamani_logo_600X390.jpg';
	...
	$summary  = preg_replace('/<p[^>]*>(.*)<\/p[^>]*>/i', '$1',$custom_summary);  //to remove first<p> and last</p>  tag
															...
															if($i == 1)
															{
																...
																$show_simple_tab.='<article style="position:relative;" class="img-boder">
																<figure><a href="'.$live_article_url.'" class="article_click" ><img src="'.$dummy_image.'" data-src="'.$show_image.'" title = "'.$imagetitle.'" alt = "'.$imagealt.'"></figure>														<figcaption class="lead-news" style="border-radius:0;">
																<h4>'.$display_title.'</h4>';
		...
		$show_simple_tab .='<div class="arrow"><a href="'.$widget_section_url.'" class="landing-arrow"><div class="arrow-span"> </div><div class="arrow-rightnew"></div></a></div>';
															 ...
															 { 
																	...
																	if($i ==2) 
																	{
																		$show_simple_tab.='<ul class="lead-list" style="background:#eee; padding: 10px;border-bottom-left-radius: 8px;   border-bottom-right-radius: 8px;">';
																	}
																	$show_simple_tab.='<li style="display:flex;"><div style="padding-right:5px;"><i class="fa fa-angle-right"></i></div>																	  																			<p>'.$display_title.'</p>
																	  </li>';
																	if($i == count($widget_contents))
																	{
																		$show_simple_tab.='</ul>';
 ...
 elseif($view_mode=="adminview")
		{
				...
				{	
				$show_simple_tab .='<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 border  margin-bottom-10">';
