...
//$sectionname = $this->db->query("CALL get_section_by_urlname('".$page_section_id."')")->result_array(); 
...
if($render_mode == "manual"){
	...
	if(count($widget_contents) > 0 ){	
		...
		{	
			...
			/*if($view_mode=="live"){
		   $body_text_details = $this->widget_model->widget_article_content_by_id($get_content['content_id'], $content_type,"");
			}
...
<tbody><tr>
<td valign="top" align="right" height="10" bgcolor="#434952" class="table280DarkButton2"><a href="<?php echo $view_it_in_browser; ?>" target="_blank" class="buttonsAndImagesLink"><img src="<?php echo static_url; ?>/images/FrontEnd/images/button_lightBG.jpg" style="display:block;" alt="IMG" border="0" align="top" hspace="0" vspace="0" width="230" height="50"></a></td>
...
<tr>																																																					
<td valign="middle" align="center" bgcolor="#434952" height="10" class="sectionRegularInfoTextDarkTD"><?php echo $summary ?> <a href="<?php echo $live_article_url; ?>" target="_blank" class="sectionRegularInfoTextDarkTDLink">மேலும்</a></td>
