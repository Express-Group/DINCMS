...
<li id="most_email_tab">அதிகம் பகிரப்பட்டவை</li>
</ul>
</div>
</div>
<div class="resp-tabs-container hor_1 cinema-tab" style="background:none;">
<div>
<div class="row">
...
$.ajax({
url			: '<?php echo base_url(); ?>user/commonwidget/getMostReadContent',
method		: 'get',
data		: { type: most_name, param: '<?php echo $content['close_param'];?>',mode:'<?php echo $view_mode;?>' , 'is_home' : window.location.href},
