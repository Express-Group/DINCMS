<?php 
/*
Finame 		: 	cinema_special
Created On 	: 	27-4-2016
Purpose for	:	Display the cinema_special widget
*/
...
$show_image	= image_url. imagelibrary_image_path.'logo/dinamani_logo_600X300.jpg';
	...
	$summary  = preg_replace('/<p[^>]*>(.*)<\/p[^>]*>/i', '$1',$custom_summary);  //to remove first<p> and last</p>  tag */
																...
																if($i==1)
																{
																	$show_simple_tab.=' <div class="cen-special cen-special1  ">
																						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><div class="cinema-special-border">
																						<ul>';
																}
																 
															$show_simple_tab.=' <li>
																				<figure class="special-img"><img src="'.$dummy_image.'" data-src="'.$show_image.'" title = "'.$imagetitle.'" alt = "'.$imagealt.'">                                                                                </figure>
																				<figcaption class="special-dec">
																				<p>'.$display_title.'</p>
																				</figcaption>
																				</li>';
