										...
										foreach($widget_contents as $get_content) {
											...
											if($i == 1) {
												...
												if($j==0){
													 ...
													 $show_simple_tab .='<a href="'.$live_article_url.'" class="article_click"><h5 class="font-size">'.$display_title.'</h5>';
													...
													// $show_simple_tab .= '<figcaption>';
													  ...
													  <div>
																	 <a href="'.$live_article_url.'" class="article_click"> <figure> <img  src="'.$custom_dummy_image.'" data-src="'.$custom_show_image.'"   title = "'.$custom_imagetitle.'" alt = "'.$custom_imagealt.'"> </figure></a>
																	  <figcaption>
																		<p  class="font-size">'.$display_title.'</p></figcaption>
																	</div>';
																	//	<p class="font-size">'.$summary.'</p>
