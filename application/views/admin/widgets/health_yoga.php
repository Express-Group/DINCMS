...
<div class="yoga margin-bottom-10">';
...
/*if($count==1)
{
$show_simple_tab .='<div class="fitness" '.$widget_bg_color.'>';
}*/
if($i==1)
{
$show_simple_tab .='<div class="fitness" '.$widget_bg_color.'>';
...
$show_simple_tab.='<articel class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
<figure><a href="'.$live_article_url.'" class="article_click" ><img src="'.$dummy_image.'" data-src="'.$show_image.'" title = "'.$imagetitle.'" alt = "'.$imagealt.'"></a></figure>	<figcaption><h4>'.$display_title .'</h4>';

if($is_summary_required==1)
$show_simple_tab.='	<p>'.$summary .'</p>';

$show_simple_tab.='</figcaption></articel>';
