...
if($j==1){
$show_image = static_url.'images/FrontEnd/images/Thevaram.jpg';
}
...
<figure> 
<img class="width-107" src="'.$dummy_image.'" data-src="'.$show_image.'" title = "'.$imagetitle.'" alt = "'.$imagealt.'"> 
</figure></a>';

$show_simple_tab .=' <figcaption><h4>'.$display_title.'</h4>';

if($is_summary_required== 1)
$show_simple_tab.='<p class="summary font-size-12">'.$summary.'</p>';
