...
$rows = ($widget_custom_title=='5') ? 5 :2;
...
if(count($widget_instance_contents)>0){			
	foreach($widget_instance_contents as $get_content){
		...
		if($rows==5){	
			$show_simple_tab.= '<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 md5">';
		}else{
			$show_simple_tab.= '<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 VideoGallerySplit">';
		}
		...
		$show_simple_tab .='</a><h4 class="subtopic1">'.$display_title.'</h4>';
