...
<div class="row" >
<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12  lead-stories" id="feature">';
	...
	if(count($widget_contents)>0)
	{
		...
		{		
			...
			else
			{
				if($i == 2)
				{
					$show_simple_tab .='<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 first-top pad-left cinema-list"><ul class="lead-list">';
				}
