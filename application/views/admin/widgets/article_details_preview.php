   ...
   <?php /*?> Published: <span><?php echo $published_date;?></span>&nbsp;&nbsp;|&nbsp;&nbsp;
     <?php  if($content_type_id!= 1){ ?>
      ...
      <!--</p>
       ...
       <p class="ArticlePublish margin-bottom-10">--> Published on : <span><?php echo $last_updated_date;?></span><?php  if($content_type_id=='1'){ ?>&nbsp;&nbsp;|&nbsp;&nbsp;
      <span class="FontSize" id="incfont" data-toggle="tooltip" title="பெரிதாக்கு">அ+</span><span class="FontSize" id="resetMe" data-toggle="tooltip" title="மீட்டமைக்க">அ&nbsp;</span><span class="FontSize" id="decfont" data-toggle="tooltip" title="சிறிதாக்கு">அ-</span> <span id="print_article">&nbsp;&nbsp;|&nbsp;&nbsp;<i class="fa fa-print"></i></span><?php } ?></p><p></p>
      
   <!--<div class="vuukle-powerbar"></div>-->
    <?php if($allow_social_btn==1) { ?>
    <div class="Social_Fonts FixedOptions" style="display:none;">
      <div class="PrintSocial" style="visibility:hidden;">  <span class="Share_Icons"><a href="javascript:;" class="csbuttons" data-type="twitter" data-txt="<?php echo strip_tags($content_title);?>" data-via="Dinamani" data-count="true"><i class="fa fa-twitter fa_social"></i></a></span> <span  class="Share_Icons"><a href="javascript:;" class="csbuttons" data-type="facebook" data-count="true"><i class="fa fa-facebook fa_social"></i></a></span> <span class="Share_Icons"><a href="javascript:;" class="csbuttons" data-type="google" data-lang="ta" data-count="true"><i class="fa fa-google-plus fa_social"></i></a></span> <span class="Share_Icons PositionRelative"><i class="fa fa-envelope-o fa_social" id="popoverId"></i><span class="csbuttons-count"><?php echo $email_shared;?></span></span>
...
<?php }
	/* ------------------------------------- Gallery content Type --------------------------------------------*/	
						...
						$gallery_description = $content_det['summaryHTML'];
						?>
<div class="row">
...
<div class="gallery_detail_skin">
  ...
  <div class="text-center play-pause-icon"> <span id="auto-play" class="cursor-pointer"><i class="fa fa-play" title="ஓட விடு"></i> </span> </div>
  <?php } ?>
...
<div class="row">
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="videodetail" style="text-align: center;"><div class="video_detail_skin">
     <?php if($content_det['VideoSite']=='ventunovideo'){ 
	?>
    <object width="630" height="441" id="ventuno_player_0" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000">
      <param name="movie" value="http://cfplayer.ventunotech.com/player/vtn_player_2.swf?vID==<?php echo $video_script;?>"/>
      <param name="allowscriptaccess" value="always"/>
      <param name="allowFullScreen" value="true"/>
      <param name="wmode" value="transparent"/>
      <embed src="http://cfplayer.ventunotech.com/player/vtn_player_2.swf?vID==<?php echo $video_script;?>" width="630" height="441" 
