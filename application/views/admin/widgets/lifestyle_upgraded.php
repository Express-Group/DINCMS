...
if(strtolower(strip_tags($widget_custom_title))!='none' && strtolower(strip_tags(trim($widget_title)))!=''){
	$show_simple_tab.='<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><h4 class="virivana-title-h4"><p>'.$widget_title.'</p></h4></div>';
}	
...
if(count($widget_contents)>0)
{
	foreach($widget_contents as $get_content) // For Get Content Start Here 
	{
		...
		$show_simple_tab.= '<div style="position:relative;">';
