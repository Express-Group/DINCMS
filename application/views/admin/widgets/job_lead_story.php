...
else
{
		...
		if($i == 1)
		{
		$show_simple_tab .=' <div class="job-border"> '; 
		
		$show_simple_tab.='<div class="job-sec" '.$widget_bg_color.' >
		
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 job-lead">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 job-list">
		<figcaption>
		<h4>'.$display_title.'</h4>';
...
<div class="arrow-rightnew"></div>
		...
		{ 
			if($i ==2) 
			{
			$show_simple_tab.='<ul class="job-sub"  >';
			}
		$show_simple_tab.='
		<li>
		<a href="'.$live_article_url.'" class="article_click" >
...
$show_simple_tab .='<div class="margin-bottom-10" style="width:100%">';
