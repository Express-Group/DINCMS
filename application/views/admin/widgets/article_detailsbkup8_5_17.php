...
<div class="row">
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ArticleDetail">
    ...
    <!--<p class="ArticlePublish margin-bottom-10">--> Published on : <span><?php echo $last_updated_date;?></span><?php  if($content_type_id=='1'){ ?>&nbsp;&nbsp;|&nbsp;&nbsp; <span class="FontSize" id="incfont" data-toggle="tooltip" title="பெரிதாக்கு">அ+</span><span class="FontSize" id="resetMe" data-toggle="tooltip" title="மீட்டமைக்க">அ&nbsp;</span><span class="FontSize" id="decfont" data-toggle="tooltip" title="சிறிதாக்கு">அ-</span> <span id="print_article">&nbsp;&nbsp;|&nbsp;&nbsp;<i class="fa fa-print"></i></span><?php } ?></p>
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ArticleDetail ArticleDetailContent">
  ...
  <?php $LiveCount=$this->widget_model->GetLiveNewsCount($content_id); if($LiveCount!=0): ?>
  <!--start of code-->
  <div class="livenow-content">
	...
	function load(){
		...
		$.ajax({
			...
			cache       : false,
			data		: {'article_id':<?php print $content_id ?>  , 'image_url': image_name },
			success     : function(result){
							if(result!=''){
								$('.livenow-content1').append(result);
							}
			},
