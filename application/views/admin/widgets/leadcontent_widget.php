...
.leadcontent_news .items .ln-content h5{margin: 10px 0 5px;font-size:15px;font-weight: bold !important;color: #000 !important;} 
...
if(trim($widget_custom_title)!=''){
	$template .='<h5 class="virivana-title-h4">'.$widget_custom_title.'</h5>';
}
