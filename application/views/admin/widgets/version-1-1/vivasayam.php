...
$template='';
$template .='<h2 class="vivasayam-title"><span class="bold_line"><span '.$widget_bg_color.'></span></span><span class="solid_line" ></span><a class="title_text"  '.$widget_bg_color.'  href="'.$widget_section_url.'">'.$widget_custom_title.'</a> </h2>';
...
if(count($widget_contents) > 0){
		...
		foreach($widget_contents as $get_content):
				...
				if($i==1){
					$template .='<div class="vivasayam-container"><a href="'.$live_article_url.'"><img src="'.$dummy_image.'" data-src="'.$show_image_390.'" class="ing-responsive"></a><h4 '.$innerbg.' >'.$display_title.'</h4></div>';
				}
				if($i==2){
					$template .='<div class="vivasayam-container">';
				}
				if($i==2 || $i==3 || $i==4 ||  $i==5){
					$template .='<div class="vivasayam-inner-container">';
				...
				if($i==6){
					$template .='<div class="vivasayam-container vivasayam-second-container">';
				}
				if($i==6 || $i==7 || $i==8){
					$template .='<div class="vivasayam-inner-container">';
					$template .='<a href="'.$live_article_url.'"><img class="img-responsive" src="'.$dummy_image.'" data-src="'.$show_image_300.'" ></a>';
