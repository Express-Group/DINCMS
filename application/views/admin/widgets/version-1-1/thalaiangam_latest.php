...
$add_sub_class='box-one bx1';
}elseif($j==1){
$add_class='box-botton font-size-11';
$add_sub_class='box-one two bx2';	
}
...
<figcaption><h4>'.$display_title.'</h4><p class="summary font-size-11">'.$summary.'</p></figcaption>'; //<time>'.date('d.m.Y',strtotime($get_content['last_updated_on'])).'</time>
