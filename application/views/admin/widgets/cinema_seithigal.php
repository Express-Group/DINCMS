...
$show_simple_tab.='<div class="row">
		  ...
		  <div '.$widget_bg_color.'>
          <div class="top-news cinema-sec boder-bottom ">';
	...
	$summary  = preg_replace('/<p[^>]*>(.*)<\/p[^>]*>/i', '$1',$custom_summary);  //to remove first<p> and last</p>  tag
											...
											$show_simple_tab.='<div>
				                                                ...
				                                                if($i>5)
																{
																	if($i==6)
																	{
																		$show_simple_tab.='<div class="latest-news">';
																	}
																	if($i%2==0)
																	{
																	...
																	<ul class="lead-list ">';
																	$show_simple_tab.=' <li>
																		<div><i class="fa fa-angle-right color-red"></i></div>
																		<p>';
																		$show_simple_tab.=$display_title ;
																		
																		if($content_type==4)
																		{
																		$show_simple_tab.='<i class="fa fa-video-camera"></i>';
																		}
																		 if($content_type==3)
																		{
																		$show_simple_tab.='<i class="fa fa-file-image-o"></i>';
																		}
																		$show_simple_tab.='</p>';
																   $show_simple_tab.='</li> ';
																	   $show_simple_tab.='</ul>
																  ...
																  if($i%2==1)
																	...
																	<ul class="lead-list latest-news-2">';
																	$show_simple_tab.=' <li>
																		<div><i class="fa fa-angle-right color-red"></i></div>
																		<p>';
																		$show_simple_tab.=$display_title ;
...
$(document).ready(function(){
 $('.cinema-lead<?php echo $widget_instance_id;?>').slick({
        dots: false,
        infinite: true,
        speed: 500,
        slidesToShow: 1,
