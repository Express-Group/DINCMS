<?php 
/*
Finame 		: 	life_style_food
Created On 	: 	11-16-2015
Purpose for	:	Display the life_style_food
*/
...
{
	$show_simple_tab	.=	'<h5 class="din-title">'.$widget_custom_title.'</h5>';
}
}
...
$show_simple_tab	.=' <div class="lifestyle-food" >';
...
if($count==1)
		...
		$show_simple_tab	.='<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 health-pad-right-0">';
		...
		$show_simple_tab	.= '<p style="color: #9c9a9a;">'.$summary.'</p>';
