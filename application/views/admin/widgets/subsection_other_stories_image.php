...
else
{
	...
	$show_simple_tab.=	'<h5><a href="">'.$widget_custom_title.'</a></h5>';
	...
	foreach($widget_contents as $key_value => $get_content)
	{
		...
		if($count <= 3)
		{
		   ...
		   $show_simple_tab.= '<div class="row">'; 
				...
				$show_simple_tab.= '<div class="item  col-lg-4 col-md-4 col-sm-4 col-xs-12 list-group-item"><div class="thumbnail"> <a  href="'.$live_article_url.'" class="article_click" ><img class="group list-group-image" src="'.$dummy_image.'" data-src="'.$show_image.'" title = "'.$imagetitle.'" alt = "'.$imagealt.'" style="width: 145px;"></a>';

				$show_simple_tab.= '<div class="caption" style="margin-left: 166px;">
