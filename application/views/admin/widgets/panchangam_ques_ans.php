...
$show_simple_tab.='</figure><figure class="bg-right"></figure> ';
							...
							if($get_content_ids!='') {
								...
								$widget_instance_contents1 = $this->widget_model->get_details_with_bodycontent($get_content_ids, $content_type, $is_home, $view_mode);	
								...
								if(count($widget_contents)>0)
								{
									foreach($widget_contents as $get_content)
									{
										...
										$custom_summary  =  ($view_mode!="live")? $get_content['ArticlePageContentHTML']: $get_content['article_page_content_html'];
