...
<div class="rasi-full">
  <h4 class="rasi-title">எண் ஜோதிடம்</h4>
...
<?php /*?>  <div class="rasi-today">
  ...
  <div class="rasi-today">
    <h4 class="rasi-title">இந்த மாத பலன்கள்</h4>
    <?php echo $numerology_results['monthly_details']; ?>
	<?php $numerology_tamil = $numerology_results['tamil_monthly_details'];
  if($numerology_tamil!='' &&  $numerology_results['monthly_details']==''){ ?>

  <?php echo $numerology_results['tamil_monthly_details']; ?>

  <?php } ?>
  </div>
  
  <div class="rasi-today">
    <h4 class="rasi-title">பொதுப் பலன்கள்</h4>
