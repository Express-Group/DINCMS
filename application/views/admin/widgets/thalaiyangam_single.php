...
{
$show_simple_tab .='<div class="tg-wrapper">';
$i =1;
...
$show_simple_tab .='<a href="'.$live_article_url.'"><img src="'.$dummy_image.'" data-src="'.$show_image.'" title="'.$imagetitle.'" alt="'.$imagealt.'"><h5>'.$display_title.'</h5></a>';
...
if($content['widget_title_link'] == 1)
{
$show_simple_tab .='<a href="'.$widget_section_url.'" class="tg-more">
					<span style="float: right;">மேலும் <i class="fa fa-arrow-right" style=" color: #071c47;"></i></span>
				</a>';
}	
