...
<div class="maruthuva-kuripu health-lead" '.$widget_bg_color.'>
<div class="top-news">';
...
$show_simple_tab.='<li>
<figure><a  class="article_click" ><img src="'.$dummy_image.'" data-src="'.$show_image.'" title = "'.$imagetitle.'" alt = "'.$imagealt.'"></a></figure>
<figcaption>'.$display_title.'
</figcaption></li>';
