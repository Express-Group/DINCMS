...
<p class="title-temp" style="font-weight: bold;color: #df0d0d;text-align: center;"><?php echo set_value('txtArticleHeadLine'); ?><?php  if(isset($get_article_details['title'])) echo strip_tags($get_article_details['title']); ?><?php  if(isset($_POST['content_title'])) echo strip_tags($_POST['content_title']); ?></p>
<?php 
...
<input style="width:100%;" type="text" id="article_head_line_id1" name="txtArticleHeadLine" value="<?php echo set_value('txtArticleHeadLine'); ?><?php  if(isset($get_article_details['title'])) echo strip_tags($get_article_details['title']); ?><?php  if(isset($_POST['content_title'])) echo strip_tags($_POST['content_title']); ?>">
    ...
    <div class="FloatLeft" style="width: 100%;">
        <input style="width: 100%;" id="count1" maxlength="100" name="txtMetaTitle" type="text" value="<?php if(isset($get_article_details['MetaTitle'])) echo htmlentities($get_article_details['MetaTitle']); echo htmlentities(set_value('txtMetaTitle')); ?><?php  if(isset($_POST['content_title'])) echo htmlentities($_POST['content_title']); ?>" class="box-shad1"/>
...
<textarea class="ckeditor" id="body_text" name="txtBodyText"><?php if(isset($get_article_details['ArticlePageContentHTML'])) echo $get_article_details['ArticlePageContentHTML']; echo set_value('txtBodyText'); ?> <?php if(isset($_POST['utm_value'])){ echo @$_POST['utm_value']; } ?></textarea>
 ...
 <input type="hidden" id="utm_lastname" name="utm_lastname" value="<?php echo $this->session->userdata('last_name'); ?>">
        ...
        <p style="">Preview</p>
		  ...
		  <label>Caption :</label>
		   <input type="text" value="<?php echo htmlentities(@$get_article_details['articleimageid']['temp_caption']);   ?><?php if(@$utm_imgcaption!=''){ echo htmlentities($utm_imgcaption); } ?>" name="article_image_caption"  maxlength=200  class="margin-top-5 WidthFull" id="article_image_caption" />
		   <label>Image Alt :</label>
		   <input type="text" value="<?php echo htmlentities(@$get_article_details['articleimageid']['temp_alt']);   ?> <?php if(@$utm_imgcaption!=''){ echo htmlentities($utm_imgcaption); } ?>" name="article_image_alt"   class="margin-top-5 WidthFull" maxlength=200 id="article_image_alt" />
		   <?php
			if($utm_imgname!=''){
    ...
    <?php echo form_error('ddCity'); ?>
         ...
         <!--  <input type="checkbox"  name="cbAllowPagination" id="cbAllowPagination"  <?php //if((isset($get_article_details['allow_pagination']) && $get_article_details['allow_pagination'] == 1 ) ) echo  "checked"; ?> />-->
		   <!-- <input type="checkbox"  name="cbAllowPagination" id="cbAllowPagination"  <?php //if(set_value("cbAllowPagination") == 'on' || $page_name != 'edit_article' ||  (isset($get_article_details['allow_pagination']) && $get_article_details['allow_pagination'] == 1 ) ) echo  "checked"; ?> />-->
			...
			<div class="padding-bottom-5">
				<input type="checkbox"  name="cbAllowAmp" id="cbAllowAmp"  checked />
		...
		<div class="example example_markup">
			<div id="seo_tagform_full"  class="bs-example1">
				<?php if(isset($seo_tags)) { 
					...
					<input type="text" name="seo_txtTags[<?php echo $seo_tag->tag_id; ?>-a]"   value="<?php echo $seo_tag->tag_name; ?>" class="tag"/>
				<?php }  } else { ?>
