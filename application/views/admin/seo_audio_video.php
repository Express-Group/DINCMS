...
<ul class="tabs margin-top-0 Article-Tab">
            ...
            <li style="display:none;" class=""><a id="section_href" href="#view2">Multi Section Mapping</a></li>
        </ul>
 ...
 <section class="tap-main Article-Tab">
    ...
    <col width="750px" />
      ...
      <!--<div id="cke_charcount_audio_video_head_line_id" length="100" class="charNum FloatRight" style="float:right;margin-bottom: 0;"><?php if(isset($get_audio_video_details['title'])) echo mb_strlen($get_audio_video_details['title']); else echo "100"?></div> -->
      	...
      	<textarea readonly class="ckeditor"  id="audio_video_head_line_id" name="txtAudioVideoHeadLine"><?php echo set_value('txtAudioVideoHeadLine'); ?><?php  if(isset($get_audio_video_details['title'])) echo $get_audio_video_details['title']; ?></textarea>
      ...
      <td><input type="text" class="box-shad" style="width:99.8% " id="txtUrlTitle" name="txtUrlTitle"   <?php if(isset($get_audio_video_details['url_title'])) { echo "readonly"; } ?>  maxlength="255" value="<?php if(isset($get_audio_video_details['url_title']) && $get_audio_video_details['url_title'] != "") { echo $get_audio_video_details['url_title']; } echo set_value('txtUrlTitle'); ?>"  />
	   <?php echo form_error('txtUrlTitle'); ?>
	    <?php if(isset($get_audio_video_details['url'])) { ?>
			 <label>URL Structure : <a href="<?php  echo BASEURL.$get_audio_video_details['url']."?page=preview"; ?>"><?php  echo BASEURL.$get_audio_video_details['url']; ?></a></label>
		<?php } ?>
      </td>
     </tr>
	 ...
	 <tr>
		...
		<textarea readonly class="ckeditor" id="summary"  name="txtSummary"><?php if(isset($get_audio_video_details['summaryHTML'])) echo $get_audio_video_details['summaryHTML']; echo set_value('txtSummary'); ?></textarea>
 ...
 -->
	<?php if($content_name == 'Video') { ?>
	 <tr>
		 <td  class="video_label"><label>Script<span style="color:#F00">*</span></label></td>
			 <td>
			<textarea  readonly class="box-shad VideoFramePreview valid" id="txtScript" name="txtScript" aria-invalid="false"><?php if(isset($get_audio_video_details['VideoScript']) && $get_audio_video_details['VideoScript'] != '') { echo $get_audio_video_details['VideoScript']; } ?></textarea>
  ...
  <select disabled name="ddMainSection" class="controls" id="main_section_id" section_data="<?php echo $select_parent_name; ?>" Value="<?php echo set_value('ddMainSection'); ?><?php echo @$get_audio_video_details['Section_id']; ?>">
   ...
   <option value="">-Select-</option>
    <?php if(isset($get_agency)) { 
	 $boolagency = true;
        ...
        <input readonly type="text" name="txtByLine" id="txtByLine" value="<?php if(isset($select_author) && $select_author != "") {  echo $select_author; } echo set_value('txtbyline'); ?>"  />
...
<div>
  ...
  <tr>
    <td></td>
    <td>   <input disabled type="checkbox"  name="cbAllowComments" id="cbAllowComments"  <?php if(set_value("cbAllowComments") == 'on' || $page_name != 'edit_video' || $page_name != 'edit_audio'  ||  (isset($get_audio_video_details['Allowcomments']) && $get_audio_video_details['Allowcomments'] == 1 ) ) echo  "checked"; ?> />
...
<div class="ArticleImageContainer1" id="audio_video_image_container" style="float:none; width:200px;<?php if(!isset($get_audio_video_details['image_details']['image_id'])) { echo "display:none;"; } else { echo "display:block;"; } ?>">
			...
			<label>Caption :</label>
			<input readonly type="text" id="audio_video_image_caption" name="audio_video_image_caption" maxlength=200 value="<?php echo htmlentities(@$get_audio_video_details['image_details']['caption']);   ?>" class="margin-top-5 WidthFull valid" aria-invalid="false">
			<label>Image Alt :</label>
			<input readonly type="text" id="audio_video_image_alt" name="audio_video_image_alt" maxlength=200 value="<?php echo htmlentities(@$get_audio_video_details['image_details']['alt_tag']);   ?>" class="margin-top-5 WidthFull valid" aria-invalid="false">
			<label>Image Name :</label>
			<input readonly type="text" id="audio_video_physical_name" name="audio_video_physical_name" maxlength=80 physical_extension="<?php echo @$get_audio_video_details['image_details']['physical_extension'];   ?>" value="<?php echo @$get_audio_video_details['image_details']['physical_name'];   ?>" class="margin-top-5 WidthFull valid" aria-invalid="false" <?php  if(isset($get_audio_video_details['image_details']['image_id'])) { ?> readonly <?php } ?>>
          </div>
   ...
   <table class="FloatLeft metatitle1">
    ...
    <div id="charNum2" class="charNum"><?php if(isset($get_audio_video_details['MetaDescription'])) echo 200 - mb_strlen($get_audio_video_details['MetaDescription']); else echo "200"?></div>
     ...
     <tr>
      ...
      <td><input disabled type="text" class="box-shad"  maxlength="252" name="txtCanonicalUrl" id="txtCanonicalUrl" value="<?php if(isset($get_audio_video_details['Canonicalurl'])) echo $get_audio_video_details['Canonicalurl'];  echo set_value('txtCanonicalUrl');?>"  />
   ...
   <ul>
    ...
    <li>
    <input disabled type="checkbox" id="cbNoIndex" name="cbNoIndex" <?php if((isset($get_audio_video_details['Noindexed']) && $get_audio_video_details['Noindexed'] == 1)  ) { ?>  checked="checked" <?php } ?>>
<label class="include_label" for="cbNoIndex">No index</label>
    </li>
    
   
    <li>
    <input disabled type="checkbox" id="cbNoFollows" name="cbNoFollows" <?php if((isset($get_audio_video_details['Nofollow']) && $get_audio_video_details['Nofollow'] == 1 ) ) { ?>  checked="checked" <?php } ?> >
