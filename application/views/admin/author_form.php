				...
				<div class="content">
					<div class="columnist1">
						...
						<div id="topicname_display" class="none">
							<p>
								<label class="txtTopicname" id="name2">Section / Topic Name</label>
							</p>
							<p></p>
						...
						<p class="Biogrpaphy" style="margin: 7px 0px;">
							<label class="biography" id="biographys">Short Biography</label>
						</p>
						<p class="TextAreaWidth">
							<textarea id="biography" name="txtbiography" class="ckeditor biography1 box-shad box-shad1"><?php if(isset($biography)){ echo $biography;}else{echo set_value('txtbiography');}?>
</textarea>
						</p>
