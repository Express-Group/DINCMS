...
define('astrology_temp_image_path','uploads/astrology/temp/');
...
define('ckeditor_astroimage_path','/uploads/user/ckeditor_images/astrology/');
define('folder_name','dmcpan');

define('image_url', 'https://images.dinamani.com/'); 
define('image_url_no', 'http://images.dinamani.com/'); 
define('static_url','https://images.dinamani.com/');

define('no_articles','Please add articles to show');	

define('BASEURL', 'https://www.dinamani.com/'); // live domain
define('BASEURLTEMP', 'http://www.dinamani.com/'); // live domain
//define('BASEURL', 'http://launch.dinamani.com/'); //test domain


define('HOMEURL', 'http://cms.dinamani.com/'); 
define('AMPURL', 'www.dinamani.com/');
define('MOBILEURL', 'https://m.dinamani.com/');
define('ONE_SIGNAL_APP_ID','d8efcd52-30be-4a55-91dc-356eb3b95eec');
define('ONE_SIGNAL_REST_API','NmZlZjBhNTktOTI2MS00MGIyLWI5ZjItZjhlMGFjZmY4MDQw');
define('WEBSTORIES_PATH','images/din_images/images/webstories/');
define('SHOWADS' , true);
