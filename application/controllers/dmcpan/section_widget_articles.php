...
class section_widget_articles extends CI_Controller
{
	...
	public function index()
	{
		...
		if($get_widget_type == "jumbo_widget_articles")
		{
			...
			$data['breadcrumb_url']   = 'dmcpan/jumbo_widget_articles';
		...
		else if($get_widget_type == "editor_pick_articles")
		{
			...
			$data['breadcrumb_url']   = 'dmcpan/editor_pick_articles';
		...
		else if($get_widget_type == "trending_now_articles")
		{
			...
			$data['breadcrumb_url']   = 'dmcpan/trending_now_articles';
			$access_url = 'trending_now_articles';
		}
		else if($get_widget_type == "jothida_manager")
		{		
			$data['Menu_id'] = get_menu_details_by_menu_name("Jothidam");
			$data['title']   = "Jothidam";
			$data['breadcrumb_url']   = 'dmcpan/jothida_manager';
			$access_url = 'jothida_manager';
		...
		{
			redirect('dmcpan/common/access_permission/'.$access_url.'');
		}
	}
	...
	public function get_widgetInstancearticle()
	{
		...
		if(trim($get_sectionname) == 'புகைப்படங்கள்')
		{
			$data['contenttype_id'] = 3;
		}
		elseif(trim($get_sectionname) == 'வீடியோக்கள்')
		{
			$data['contenttype_id'] = 4;
		}
		elseif(trim($get_sectionname) == 'ஆடியோக்கள்')
		{
		...
		else if($search_by_widget_type == "jothida_manager")
		{
			//$widget_type = "O";
			$widget_type   = "4";
			$get_sectionID = 0; 
		...
		$data['search_bysection'] = $current_widget_section_id;
	...
	public function widgetarticle_customdetails()
	{
		...
		if(($custom_details['get_sectionname']) == 'புகைப்படங்கள்')
		{
			$custom_details['content_type'] = '3';
		}
		else if(($custom_details['get_sectionname']) == 'வீடியோக்கள்')
		{
			$custom_details['content_type'] = '4';
		}
		else if(($custom_details['get_sectionname']) == 'ஆடியோக்கள்')
		{
