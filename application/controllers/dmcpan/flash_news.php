...
class flash_news extends CI_Controller{
	...
	public function index(){
		...
		$filename = FCPATH.'application/views/flash/flash1.news';
		$view['contents'] = 'EMPTY';
	...
	public function insertnews(){
		...
		if($data!=''){
			...
			$this->history($result);
			$this->movetolive('flash1.news',$result);
	...
	public function movetolive($file_name,$file_data){
		...
		$ch = curl_init();
		curl_setopt($ch, CURLOPT_URL, 'http://www.newindianexpress.com/'.'user/commonwidget/save_flashnews');
