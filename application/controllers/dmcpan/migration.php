...
{	
	...
	{	
		...
		$this->xml_path = "/home/din_images/XML/";
		
		$this->ecenic_image_path = '/home/din_images/ecenic_images/';
	}
	...
	public function index()  {
		...
		//$picture_xml_file_path =  $this->xml_path."2013/dn-full-gallery-with-uri-jul-2015-to-apr-2016.xml";

		
		//$xml = get_object_vars(simplexml_load_file($picture_xml_file_path));

		
		$data['TotalCount']			= 0;//count($xml['Content']);
		...
		$news_xml_file_path  = $this->xml_path."2010/dn-2010-jan-01-10-news-without-uri.xml";
		...
		$picture_xml_file_path = $this->xml_path."dn-full-gallery-without-uri-2009-2013.xml";
		
		//$xml = get_object_vars(simplexml_load_file($picture_xml_file_path));
		
		$data['GalleryTotalCount']			=  0;//count($xml['Content']);
		
		$data['GalleryTotalSuccess']			= 0;//$this->migration_model->get_ecenic_content(1,3);
		$data['GalleryTotalFailure']			= 0;//$this->migration_model->get_ecenic_content(2,3);
	...
	{	
		...
		$picture_xml_file_path =  $this->xml_path."2012/dn-2012-dec-pictures-without-uri.xml";
...
$txt = $Contents->ArticleURI."\n";
	...
	{	
		...
		$picture_xml_file_path =  image_url."/XML/2016/dn-2016-aug-1-11-news.xml";
		...
		if($xml != '' && !empty($xml))
		{
			...
			$Slice_Content  = array_slice($xml['Content'],6000,1000);
		/*
			echo "<pre>";
			print_r($Slice_Content);
			exit;
*/
			...
			} elseif($Contents->sectionID == 242 || $Contents->sectionID == 243 || $Contents->sectionID == 244 || $Contents->sectionID == 245 || $Contents->sectionID == 246 || $Contents->sectionID == 247 || $Contents->sectionID == 248 ) {
	...
	{	
		...
		$picture_xml_file_path = $this->xml_path."2015/dn-2015-sep-01-10-news.xml";
		$ImagePath 				= imagelibrary_image_path;
...
/*
	...
	*/
	...
	{	
		...
		$picture_xml_file_path = image_url."/XML/dn-full-gallery-with-uri-may-2016-to-aug-11-2016.xml";
		...
		if($xml != '' && !empty($xml))
		{
			...
			$Slice_Content  = array_slice($xml['Content'],0,200);
	...
	{	
		...
		$picture_xml_file_path = $this->xml_path."dn-full-gallery-with-uri-jul-2015-to-apr-2016.xml";
		...
		if($xml != '' && !empty($xml))
		{
			...
			$Slice_Content  = array_slice($xml['Content'],700,100);
	...
	public function get_video() {
		...
		$picture_xml_file_path = image_url."/XML/dn-full-videos-with-uri-may-2016-to-aug-11-2016.xml";
		...
		if($xml != '' && !empty($xml))
		{
			...
			$Slice_Content  = array_slice($xml['Content'],0,100);
	...
	public function get_video_for_archive() {
		...
		$picture_xml_file_path = $this->xml_path."dn-full-videos-with-uri-jul-2015-to-apr-2016.xml";
