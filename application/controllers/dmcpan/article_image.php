...

	{
			...
			ImageJPEG(ImageCreateFromString(file_get_contents($data['upload_data']['full_path'])),$data['upload_data']['full_path'], image_resolution);
				if($this->input->post('watermark')==1){
					...
					$waterMarkConfig['source_image'] = $data['upload_data']['full_path'];
					$waterMarkConfig['wm_overlay_path'] = source_base_path.'images/watermark/450x140.png';
					$waterMarkConfig['wm_type'] = 'overlay';
					$waterMarkConfig['wm_opacity'] = '100';
					$waterMarkConfig['wm_vrt_alignment'] = 'middle';
					$waterMarkConfig['wm_hor_alignment'] = 'center';
