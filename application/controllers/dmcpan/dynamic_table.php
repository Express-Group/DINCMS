...
class dynamic_table extends CI_Controller{
	...
	public function index(){
		...
		$Template['election_tables']=$this->dynamic_table_model->electiontable('' ,'' ,2);
	...
	public function election_table(){
		echo $this->dynamic_table_model->electiontable($this->input->post('title') , $this->input->post('list'));
	}
}
?>