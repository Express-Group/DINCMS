	...
	public function save_html_template($menuid , $pagetype)
	{
		...
		if($xml != '' && !empty($xml))
		{
		   ...
		   $viewpage = $this->load->view("admin/view_frontend", $data, true);
			...
			//$body 		= $this->load_saved_template_data($right_panel_xml, 'left', "template_body", $tmpl_values, '', $is_home_page, $static_view, $viewmode, '', $pagetype, $page_param,  "live", $page_details);
			if ($body!=''){
