...
public function get_panchangam_content(){
  ...
  public function update_hits()
  {
	...
	$content_type = $get_content_types[0];
	$content_id   = $get_content_ids[$get_content_id[0]];
	if($content_id!='')
	{
	$widget_instance_contents1 = $this->widget_model->get_contentdetails_from_database($content_id, $content_type, "n", $view_mode);	
