    ...
    $.fn.extend({ 
        MyPagination: function(options) {
            ...
            showPage = function(page) {
				...
				if(page==total_page){ $("#storyContent .page").last().after($('#RelatedArticle').show().css({"display":"flex", "justify-content":"center"}));}else{$('#RelatedArticle').hide();}
            };
...
jQuery(window).load(function() {
	...
	$("#storyContent").after($('#RelatedArticle').show().css({"display":"flex", "justify-content":"center"}));
	}
