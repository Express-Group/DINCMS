...
(function($)
{
		...
		{	
			...
			$(this).on('click tap', function()
			{
				...
				var top 	= (screen.height/2)-(popupHeight/2);
					...
					var short_url = get_shorten_url(popupWindow, txt, popupHeight, popupWidth, left, top, via, shareFrom, lang);
 ...
 function get_shorten_url(popupWindow, txt, popupHeight, popupWidth, left, top, via, shareFrom, lang){
	$.ajax({
			...
			shareUrl	= (via != null) ? shareUrl + '&via=' + via : shareUrl;
			}else if(shareFrom=="facebook"){
			shareUrl	= 'https://www.facebook.com/sharer/sharer.php?u=' + short_url;
			}else if(shareFrom=="google"){
			shareUrl 	= 'https://plus.google.com/share?url=' + short_url;
			shareUrl 	= (lang != null) ? shareUrl + '&hl=' + lang : shareUrl;
			}
