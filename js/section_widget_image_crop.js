...
$(document).ready(function()
{
	...
	// Apply Crop Functioanlity 
		$("#apply_crop").click(function() {
				...
				var postdata = "crop_image_id="+crop_image_id+"&crop_data="+crop_data+"&crop_alt="+crop_alt+"&crop_caption="+crop_caption+"&crop_height="+crop_height+"&crop_width="+crop_width+"&image_type="+image_type+"&content_id="+image_content_id+"&image_imagetype="+image_imagetype;
					$.ajax({
						url: base_url+"dmcpan/section_widget_articles/crop_custom_image", // Url to which the request is send
	...
	// Apply Crop Functioanlity 
			...
			function common_resize_process(image_type) {
				...
				var postdata = "crop_image_id="+crop_image_id+"&crop_data="+crop_data+"&crop_alt="+crop_alt+"&crop_caption="+crop_caption+"&crop_height="+crop_height+"&crop_width="+crop_width+"&image_type="+image_type+"&content_id="+image_content_id+"&image_imagetype="+image_imagetype;;
					$.ajax({
						url: base_url+"dmcpan/section_widget_articles/resize_custom_image", // Url to which the request is send
						type: "POST",             // Type of request to be send, called as method
						data:  postdata,
						dataType: "json",
						async: true, 
 ...
 return bool;
	...
	$("#active_id").click(function() {
			...
			if(confirm_status==true) {
				...
				$.ajax({
							url: base_url+"dmcpan/section_widget_articles/update_custom_image_changes", // Url to which the request is send
							type: "POST",             // Type of request to be send, called as method
							data:  postdata,
							dataType: "json",
							async: true, 
