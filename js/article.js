...
var main_section_text = $.trim($( "#main_section_id option:selected" ).text());
	...
	/*	if(main_section_text == 'Nation') {
		...
		var if_condition = (main_section_text  == 'Editorials' || main_section_data == 'Columns' || main_section_data == 'Magazine' || main_section_data == 'The Sunday Standard' || main_section_text == 'Voices');
...
$("#drop-area").on('dragenter', function (e){
	...
	$("#main_section_id").change(function(){
		...
		var if_condition = (main_section_text  == 'Editorials' || main_section_text  == 'Columns' ||  main_section_text  == 'Magazine'  ||  main_section_text  == 'The Sunday Standard'  || main_section_data == 'Columns' || main_section_data == 'Magazine' || main_section_data == 'The Sunday Standard' || main_section_text == 'Voices'); 
    ...
    CKEDITOR.replace( 'summary', {
		...
		CKEDITOR.replace( 'body_text', {
		  ...
		  {items: [ 'Source','Strike','Subscript','Superscript','NumberedList','BulletedList','Outdent','Indent','Blockquote','Table','HorizontalRule','Smiley','SpecialChar','PageBreak','Iframe'] }
		    ...
		    extraPlugins: 'autogrow,html5audio,embed,colordialog', 
