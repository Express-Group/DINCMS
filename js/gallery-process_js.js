					...
					if(Bool)  
					{
						...
						physical_name = physical_name.replace(/[^a-zA-Z0-9_-]/g,'');
						 ...
						 if(parseInt(Index+1)%2 != 0)
							...
							var	Content = "<tr  "+Class+" id='gallery_image"+data.image_id+"'><td id='index"+Index+"' class='index' data-image_id='"+data.image_id+"' data-image_caption='"+data.caption+"' data-image_alt='"+data.alt+"' data-physical_name='"+data.physical_name+"' data-physical_extension='"+data.physical_extension+"' data-image1_type='"+data.image1_type+"'  data-image2_type='"+data.image2_type+"'  data-image3_type='"+data.image3_type+"'   data-image4_type='"+data.image4_type+"'   data-imagecontent_id='"+ ImageDetails.content_id+"' data-source='"+data.source+"' >"+parseInt(Index+1)+"</td><td><img class='gallery_dataimage' src='"+data.source+"'/></td><td><div align='center'><input type='textbox' style='width:200px; text-align:center;'  name='image_caption' id='image_caption_id' rel='"+Index+"' maxlength=200 value='"+data.caption+ "' /></div></td><td><div align='center'><input type='textbox' style='width:200px; text-align:center;'  name='image_alt' id='image_alt_id' maxlength=200 rel='"+Index+"' value='"+data.alt+"' /></div></td><td><div align='center'><input type='textbox' style='width:100%; text-align:center;'  name='physical_name' maxlength=80 temp_id='"+data.image_id+"' id='physical_name' physical_extension='"+data.physical_extension+"'   rel='"+Index+"'  value='"+physical_name+"' /></div><span class='error' id='error_"+data.image_id+"'></span></td><td><div class='article_table_delete'>  <a  id='edit_image' rel='"+data.image_id+"' href='javascript:void(0);' class='button tick tooltip-2' data-toggle='tooltip'   title='Edit' data-original-title='Edit'><i class='fa fa-pencil'></i></a><a class='button cross' href='javascript:void(0)' data-toggle='tooltip'   title='Delete' data-original-title='Delete' id='deletetempimage' index_value='"+Index+"' rel='"+data.image_id+"' ><i class='fa fa-trash-o'></i></a></div></td></tr>";
						 ...
						 'image1_type' 			: data[key].image1_type,
						  ...
						  'image4_type' 		: data[key].image4_type,
						   ...
						   if(parseInt(Index+1)%2 != 0)
							...
							var	Content = "<tr "+Class+" id='gallery_image"+data[key].image_id+"'><td id='index"+Index+"' class='index' data-image_id='"+data[key].image_id+"' data-image_caption='"+data[key].caption+"' data-image_alt='"+data[key].alt_tag+"' data-physical_name='"+data[key].physical_name+"' data-physical_extension='"+data[key].physical_extension+"' data-image1_type='"+data[key].image1_type+"'  data-image2_type='"+data[key].image2_type+"'  data-image3_type='"+data[key].image3_type+"'   data-image4_type='"+data[key].image4_type+"'   data-imagecontent_id='"+data[key].imagecontent_id+"'  data-source='"+data[key].image+"'  >"+parseInt(Index+1)+"</td><td><img class='gallery_dataimage' src='"+data[key].image+"'/></td><td><div align='center'><input type='textbox' style='width:200px; text-align:center;'  name='image_caption' id='image_caption_id' rel='"+Index+"'  maxlength=200  value='"+data[key].caption+ "' /></div></td><td><div align='center'><input type='textbox' style='width:200px; text-align:center;'  name='image_alt' id='image_alt_id' maxlength=200 rel='"+Index+"' value='"+data[key].alt_tag+"' /></div></td><td><div align='center'><input type='textbox' style='width:100%; text-align:center;' physical_extension='"+data[key].physical_extension+"'   rel='"+Index+"'    name='physical_name' maxlength=80  id='physical_name' temp_id='"+data[key].image_id+"' rel='"+data[key].image_id+"' value='"+physical_name+"' /></div><span class='error' id='error_"+data[key].image_id+"'></span></td><td><div class='article_table_delete'>  <a  id='edit_image' rel='"+data[key].image_id+"' href='javascript:void(0);' class='button tick tooltip-2' data-toggle='tooltip'   title='Edit' data-original-title='Edit'><i class='fa fa-pencil'></i></a><a class='button cross' href='javascript:void(0)' data-toggle='tooltip'   title='Delete' data-original-title='Delete' id='deletetempimage' index_value="+Index+" rel='"+data[key].image_id+"' ><i class='fa fa-trash-o'></i></a></div></td></tr>";
					...
					if(data.status == 1) {
						...
						if(folder_name != 'niecpan') 
						 ...
						 if(parseInt(Index+1)%2 != 0)
							...
							var	Content = "<tr "+Class+" id='gallery_image"+data.image_id+"'><td id='index"+Index+"'  class='index' data-image_id='"+data.image_id+"' data-image_caption='"+data.caption+"' data-image_alt='"+data.alt_tag+"' data-physical_name='"+data.physical_name+"' data-physical_extension='"+data.physical_extension+"' data-image1_type='"+data.image1_type+"'  data-image2_type='"+data.image2_type+"'  data-image3_type='"+data.image3_type+"'   data-image4_type='"+data.image4_type+"'   data-imagecontent_id='"+data.imagecontent_id+"'  data-source='"+data.image+"' >"+parseInt(Index+1)+"</td><td><img class='gallery_dataimage' src='"+data.image+"'/></td><td><div align='center'><input type='textbox' style='width:200px; text-align:center;'  name='image_caption' id='image_caption_id' rel='"+Index+"'  maxlength=200  value='"+data.caption+ "' /></div></td><td><div align='center'><input type='textbox' style='width:200px; text-align:center;'  name='image_alt' id='image_alt_id' rel='"+Index+"'  maxlength=200  value='"+data.alt_tag+"' /></div></td><td><div align='center'><input type='textbox' style='width:100%; text-align:center;'  maxlength=80  name='physical_name' temp_id='"+data.image_id+"' id='physical_name' physical_extension='"+data.physical_extension+"'   rel='"+Index+"'  value='"+physical_name+"' /></div><span class='error' id='error_"+data.image_id+"'></span></td><td><div class='article_table_delete'>  <a  id='edit_image' rel='"+data.image_id+"' href='javascript:void(0);' class='button tick tooltip-2' data-toggle='tooltip'   title='Edit' data-original-title='Edit'><i class='fa fa-pencil'></i></a><a class='button cross' href='javascript:void(0)' data-toggle='tooltip'   title='Delete' data-original-title='Delete' id='deletetempimage' index_value="+Index+" rel='"+data.image_id+"' ><i class='fa fa-trash-o'></i></a></div></td></tr>";
...
function rearrange_gallery_container() {
	...
	if(Length_SelectImage!= 0) {
		...
		for(Count = 0; Count < Length_SelectImage ; Count++) {
			...
			console.log("rearray"+Count);
			
			var data = SelectImage[Count];
			
			console.log(data);
			
							var	Content = "<tr  "+Class+" id='gallery_image"+data.image_id+"'><td  id='index"+Index+"' class='index' data-image_id='"+data.image_id+"' data-image_caption='"+data.image_caption+"' data-image_alt='"+data.image_alt+"' data-physical_name='"+data.physical_name+"' data-physical_extension='"+data.physical_extension+"' data-image1_type='"+data.image1_type+"'  data-image2_type='"+data.image2_type+"'  data-image3_type='"+data.image3_type+"'   data-image4_type='"+data.image4_type+"'   data-imagecontent_id='"+data.imagecontent_id+"'  data-source='"+data.source+"' >"+parseInt(Index+1)+"</td><td><img class='gallery_dataimage' src='"+data.source+"'/></td><td><div align='center'><input type='textbox' style='width:200px; text-align:center;'  name='image_caption' id='image_caption_id' rel='"+Index+"' value='"+data.image_caption+ "' maxlength=200 /></div></td><td><div align='center'><input type='textbox' style='width:200px; text-align:center;'  name='image_alt' id='image_alt_id' rel='"+Index+"'  value='"+data.image_alt+"'  maxlength=200 /></div></td><td><div align='center'><input type='textbox' style='width:100%; text-align:center;'  name='physical_name'  maxlength=80 id='physical_name' physical_extension='"+data.physical_extension+"' temp_id='"+data.image_id+"'  rel='"+Index+"'  value='"+data.physical_name+"' /></div><span class='error' id='error_"+data.image_id+"'></span></td><td><div class='article_table_delete'>  <a  id='edit_image' rel='"+data.image_id+"' href='javascript:void(0);' class='button tick tooltip-2' data-toggle='tooltip'   title='Edit' data-original-title='Edit'><i class='fa fa-pencil'></i></a><a class='button cross' href='javascript:void(0)' data-toggle='tooltip'   title='Delete' data-original-title='Delete' id='deletetempimage' index_value='"+Count+"' rel='"+data.image_id+"' ><i class='fa fa-trash-o'></i></a></div></td></tr>";
